...
export function dew() {
  ...
  (function (exports, global) {
    ...
    function DefaultsError(msg, defs) {
      Error.call(this || _global, msg);
      (this || _global).msg = msg;
      (this || _global).defs = defs;
    }
    ...
    function Dictionary() {
      (this || _global)._values = Object.create(null);
      (this || _global)._size = 0;
    }

    Dictionary.prototype = {
      set: function (key, val) {
        if (!this.has(key)) ++(this || _global)._size;
        (this || _global)._values["$" + key] = val;
        return this || _global;
      },
      ...
      get: function (key) {
        return (this || _global)._values["$" + key];
      },
      del: function (key) {
        if (this.has(key)) {
          --(this || _global)._size;
          delete (this || _global)._values["$" + key];
        }

        return this || _global;
      },
      has: function (key) {
        return "$" + key in (this || _global)._values;
      },
      each: function (f) {
        for (var i in (this || _global)._values) f((this || _global)._values[i], i.substr(1));
      },
      size: function () {
      ...
      map: function (f) {
        ...
        for (var i in (this || _global)._values) ret.push(f((this || _global)._values[i], i.substr(1)));

        return ret;
      },
      toObject: function () {
        return (this || _global)._values;
      }
    };
    ...
    function DEFNODE(type, props, methods, base) {
      ...
      ctor.DEFMETHOD = function (name, method) {
        (this || _global).prototype[name] = method;
      };
    ...
    var AST_Node = DEFNODE("Node", "start end", {
      clone: function () {
        return new (this || _global).CTOR(this || _global);
      },
      ...
      _walk: function (visitor) {
        return visitor._visit(this || _global);
      },
    ...
    var AST_SimpleStatement = DEFNODE("SimpleStatement", "body", {
      ...
      _walk: function (visitor) {
        return visitor._visit(this || _global, function () {
          (this || _global).body._walk(visitor);
        });
      }
    }, AST_Statement);
    ...
    var AST_Block = DEFNODE("Block", "body", {
      ...
      _walk: function (visitor) {
        return visitor._visit(this || _global, function () {
          walk_body(this || _global, visitor);
        });
      }
    }, AST_Statement);
    ...
    var AST_LabeledStatement = DEFNODE("LabeledStatement", "label", {
      ...
      _walk: function (visitor) {
        return visitor._visit(this || _global, function () {
          (this || _global).label._walk(visitor);
    ...
    var AST_Do = DEFNODE("Do", null, {
      ...
      _walk: function (visitor) {
        return visitor._visit(this || _global, function () {
          ...
          (this || _global).condition._walk(visitor);
        });
      }
    }, AST_DWLoop);
    ...
    var AST_For = DEFNODE("For", "init condition step", {
      ...
      _walk: function (visitor) {
        return visitor._visit(this || _global, function () {
          if ((this || _global).init) (this || _global).init._walk(visitor);
          if ((this || _global).condition) (this || _global).condition._walk(visitor);
          if ((this || _global).step) (this || _global).step._walk(visitor);
    ...
    var AST_ForIn = DEFNODE("ForIn", "init name object", {
      ...
      _walk: function (visitor) {
        return visitor._visit(this || _global, function () {
          (this || _global).init._walk(visitor);

          (this || _global).object._walk(visitor);
    ...
    var AST_With = DEFNODE("With", "expression", {
      ...
      _walk: function (visitor) {
        return visitor._visit(this || _global, function () {
          (this || _global).expression._walk(visitor);
    ...
    var AST_Lambda = DEFNODE("Lambda", "name argnames uses_arguments", {
      ...
      _walk: function (visitor) {
        return visitor._visit(this || _global, function () {
          if ((this || _global).name) (this || _global).name._walk(visitor);

          (this || _global).argnames.forEach(function (arg) {
            arg._walk(visitor);
          });
    ...
    var AST_Exit = DEFNODE("Exit", "value", {
      ...
      _walk: function (visitor) {
        return visitor._visit(this || _global, (this || _global).value && function () {
          (this || _global).value._walk(visitor);
        });
      }
    }, AST_Jump);
    ...
    var AST_LoopControl = DEFNODE("LoopControl", "label", {
      ...
      _walk: function (visitor) {
        return visitor._visit(this || _global, (this || _global).label && function () {
          (this || _global).label._walk(visitor);
        });
      }
    }, AST_Jump);
    ...
    var AST_If = DEFNODE("If", "condition alternative", {
      ...
      _walk: function (visitor) {
        return visitor._visit(this || _global, function () {
          ...
          if ((this || _global).alternative) (this || _global).alternative._walk(visitor);
        });
      }
    }, AST_StatementWithBody);
    ...
    var AST_Try = DEFNODE("Try", "bcatch bfinally", {
      ...
      _walk: function (visitor) {
        return visitor._visit(this || _global, function () {
          walk_body(this || _global, visitor);
          if ((this || _global).bcatch) (this || _global).bcatch._walk(visitor);
          if ((this || _global).bfinally) (this || _global).bfinally._walk(visitor);
        });
      }
    }, AST_Block);
    var AST_Catch = DEFNODE("Catch", "argname", {
      ...
      _walk: function (visitor) {
        return visitor._visit(this || _global, function () {
          (this || _global).argname._walk(visitor);
    ...
    var AST_Definitions = DEFNODE("Definitions", "definitions", {
      ...
      _walk: function (visitor) {
        return visitor._visit(this || _global, function () {
          (this || _global).definitions.forEach(function (def) {
            def._walk(visitor);
          });
        });
      }
    ...
    var AST_VarDef = DEFNODE("VarDef", "name value", {
      ...
      _walk: function (visitor) {
        return visitor._visit(this || _global, function () {
          (this || _global).name._walk(visitor);

          if ((this || _global).value) (this || _global).value._walk(visitor);
        });
      }
    });
    var AST_Call = DEFNODE("Call", "expression args", {
      ...
      _walk: function (visitor) {
        return visitor._visit(this || _global, function () {
          ...
          (this || _global).args.forEach(function (arg) {
            arg._walk(visitor);
          });
        });
      }
    ...
    var AST_Seq = DEFNODE("Seq", "car cdr", {
      ...
      _walk: function (visitor) {
        return visitor._visit(this || _global, function () {
          (this || _global).car._walk(visitor);

          if ((this || _global).cdr) (this || _global).cdr._walk(visitor);
        });
      }
    });
    ...
    var AST_Sub = DEFNODE("Sub", null, {
      ...
      _walk: function (visitor) {
        return visitor._visit(this || _global, function () {
          ...
          (this || _global).property._walk(visitor);
        });
      }
    }, AST_PropAccess);
    ...
    var AST_Binary = DEFNODE("Binary", "left operator right", {
      ...
      _walk: function (visitor) {
        return visitor._visit(this || _global, function () {
          (this || _global).left._walk(visitor);

          (this || _global).right._walk(visitor);
        });
      }
    });
    var AST_Conditional = DEFNODE("Conditional", "condition consequent alternative", {
      ...
      _walk: function (visitor) {
        return visitor._visit(this || _global, function () {
          ...
          (this || _global).consequent._walk(visitor);

          (this || _global).alternative._walk(visitor);
        });
      }
    });
    ...
    var AST_Array = DEFNODE("Array", "elements", {
      ...
      _walk: function (visitor) {
        return visitor._visit(this || _global, function () {
          (this || _global).elements.forEach(function (el) {
            el._walk(visitor);
          });
        });
      }
    ...
    var AST_Object = DEFNODE("Object", "properties", {
      ...
      _walk: function (visitor) {
        return visitor._visit(this || _global, function () {
          (this || _global).properties.forEach(function (prop) {
            prop._walk(visitor);
          });
        });
      }
    ...
    var AST_Label = DEFNODE("Label", "references", {
      ...
      initialize: function () {
        (this || _global).references = [];
        (this || _global).thedef = this || _global;
      }
    }, AST_Symbol);
    ...
    function TreeWalker(callback) {
      (this || _global).visit = callback;
      (this || _global).stack = [];
      (this || _global).directives = Object.create(null);
    }
    ...
    TreeWalker.prototype = {
      ...
      parent: function (n) {
        return (this || _global).stack[(this || _global).stack.length - 2 - (n || 0)];
      },
      push: function (node) {
        if (node instanceof AST_Lambda) {
          (this || _global).directives = Object.create((this || _global).directives);
        } else if (node instanceof AST_Directive) {
          (this || _global).directives[node.value] = (this || _global).directives[node.value] ? "up" : true;
        }

        (this || _global).stack.push(node);
      },
      pop: function (node) {
        (this || _global).stack.pop();

        if (node instanceof AST_Lambda) {
          (this || _global).directives = Object.getPrototypeOf((this || _global).directives);
        }
      },
      self: function () {
        return (this || _global).stack[(this || _global).stack.length - 1];
      },
      find_parent: function (type) {
        var stack = (this || _global).stack;
      ...
      has_directive: function (type) {
        var dir = (this || _global).directives[type];
        if (dir) return dir;
        var node = (this || _global).stack[(this || _global).stack.length - 1];
    ...
    function JS_Parse_Error(message, filename, line, col, pos) {
      ...
      (this || _global).filename = filename;
      (this || _global).line = line;
      (this || _global).col = col;
      (this || _global).pos = pos;
      (this || _global).stack = new Error().stack;
    }

    JS_Parse_Error.prototype.toString = function () {
      return (this || _global).message + " (line: " + (this || _global).line + ", col: " + (this || _global).col + ", pos: " + (this || _global).pos + ")" + "\n\n" + (this || _global).stack;
    };
    ...
    function TreeTransformer(before, after) {
      TreeWalker.call(this || _global);
      (this || _global).before = before;
      (this || _global).after = after;
    }
    ...
    (function (undefined) {
      function _(node, descend) {
        node.DEFMETHOD("transform", function (tw, in_list) {
          var x, y;
          tw.push(this || _global);
          if (tw.before) x = tw.before(this || _global, descend, in_list);
          ...
          if (x === undefined) {
            if (!tw.after) {
              ...
              tw.stack[tw.stack.length - 1] = x = this || _global;
              descend(x, tw);
    ...
    function SymbolDef(scope, index, orig) {
      (this || _global).name = orig.name;
      (this || _global).orig = [orig];
      (this || _global).scope = scope;
      (this || _global).references = [];
      (this || _global).global = false;
      (this || _global).mangled_name = null;
      (this || _global).undeclared = false;
      (this || _global).constant = false;
    ...
    SymbolDef.prototype = {
      unmangleable: function (options) {
        if (!options) options = {};
        return (this || _global).global && !options.toplevel || (this || _global).undeclared || !options.eval && ((this || _global).scope.uses_eval || (this || _global).scope.uses_with) || options.keep_fnames && ((this || _global).orig[0] instanceof AST_SymbolLambda || (this || _global).orig[0] instanceof AST_SymbolDefun);
      },
      mangle: function (options) {
        var cache = options.cache && options.cache.props;

        if ((this || _global).global && cache && cache.has((this || _global).name)) {
          (this || _global).mangled_name = cache.get((this || _global).name);
        } else if (!(this || _global).mangled_name && !this.unmangleable(options)) {
          var s = (this || _global).scope;
          if (!options.screw_ie8 && (this || _global).orig[0] instanceof AST_SymbolLambda) s = s.parent_scope;
          (this || _global).mangled_name = s.next_mangled(options, this || _global);

          if ((this || _global).global && cache) {
            cache.set((this || _global).name, (this || _global).mangled_name);
          }
        }
      }
    };
    AST_Toplevel.DEFMETHOD("figure_out_scope", function (options) {
      ...
      if (options.cache) {
        (this || _global).cname = options.cache.cname;
      }
    });
    AST_Scope.DEFMETHOD("init_scope_vars", function (nesting) {
      (this || _global).variables = new Dictionary();
      (this || _global).functions = new Dictionary();
      (this || _global).uses_with = false;
      (this || _global).uses_eval = false;
      (this || _global).parent_scope = null;
      (this || _global).enclosed = [];
      (this || _global).cname = -1;
      (this || _global).nesting = nesting;
    });
    AST_Lambda.DEFMETHOD("init_scope_vars", function () {
      AST_Scope.prototype.init_scope_vars.apply(this || _global, arguments);
      (this || _global).uses_arguments = false;
      var symbol = new AST_VarDef({
        name: "arguments",
        start: (this || _global).start,
        end: (this || _global).end
      });
      var def = new SymbolDef(this || _global, (this || _global).variables.size(), symbol);

      (this || _global).variables.set(symbol.name, def);
    });
    AST_SymbolRef.DEFMETHOD("reference", function () {
      var def = this.definition();
      def.references.push(this || _global);
      var s = (this || _global).scope;
      ...
      (this || _global).frame = (this || _global).scope.nesting - def.scope.nesting;
    });
    AST_Scope.DEFMETHOD("find_variable", function (name) {
      if (name instanceof AST_Symbol) name = name.name;
      return (this || _global).variables.get(name) || (this || _global).parent_scope && (this || _global).parent_scope.find_variable(name);
    });
    AST_Scope.DEFMETHOD("def_function", function (symbol) {
      (this || _global).functions.set(symbol.name, this.def_variable(symbol));
    });
    AST_Scope.DEFMETHOD("def_variable", function (symbol) {
      var def;

      if (!(this || _global).variables.has(symbol.name)) {
        def = new SymbolDef(this || _global, (this || _global).variables.size(), symbol);

        (this || _global).variables.set(symbol.name, def);

        def.global = !(this || _global).parent_scope;
      } else {
        def = (this || _global).variables.get(symbol.name);
    ...
    AST_Scope.DEFMETHOD("next_mangled", function (options) {
      var ext = (this || _global).enclosed;

      out: while (true) {
        var m = base54(++(this || _global).cname);
    ...
    AST_Function.DEFMETHOD("next_mangled", function (options, def) {
      var tricky_def = def.orig[0] instanceof AST_SymbolFunarg && (this || _global).name && (this || _global).name.definition();

      while (true) {
        var name = AST_Lambda.prototype.next_mangled.call(this || _global, options, def);
        if (!(tricky_def && tricky_def.mangled_name == name)) return name;
      }
    });
    AST_Scope.DEFMETHOD("references", function (sym) {
      if (sym instanceof AST_Symbol) sym = sym.definition();
      return (this || _global).enclosed.indexOf(sym) < 0 ? null : sym;
    });
    ...
    AST_Symbol.DEFMETHOD("unreferenced", function () {
      return this.definition().references.length == 0 && !((this || _global).scope.uses_eval || (this || _global).scope.uses_with);
    });
    ...
    AST_Symbol.DEFMETHOD("definition", function () {
      return (this || _global).thedef;
    });
    AST_Symbol.DEFMETHOD("global", function () {
      return this.definition().global;
    });
    AST_Var.DEFMETHOD("has_const_pragma", function () {
      var comments_before = (this || _global).start && (this || _global).start.comments_before;
    ...
    AST_Toplevel.DEFMETHOD("mangle_names", function (options) {
      ...
      if (options.cache) {
        (this || _global).globals.each(function (symbol) {
      ...
      if (options.cache) {
        options.cache.cname = (this || _global).cname;
      }
    });
    ...
    (function () {
      ...
      PARENS([AST_Unary, AST_Undefined], function (output) {
        var p = output.parent();
        return p instanceof AST_PropAccess && p.expression === (this || _global);
      });
      ...
      PARENS(AST_Binary, function (output) {
        var p = output.parent();
        if (p instanceof AST_Call && p.expression === (this || _global)) return true;
        if (p instanceof AST_Unary) return true;
        if (p instanceof AST_PropAccess && p.expression === (this || _global)) return true;

        if (p instanceof AST_Binary) {
          var po = p.operator,
              pp = PRECEDENCE[po];
          var so = (this || _global).operator,
              sp = PRECEDENCE[so];

          if (pp > sp || pp == sp && (this || _global) === p.right) {
            return true;
          }
        }
      });
      PARENS(AST_PropAccess, function (output) {
        ...
        if (p instanceof AST_New && p.expression === (this || _global)) {
          try {
      ...
      PARENS(AST_Call, function (output) {
        var p = output.parent(),
            p1;
        if (p instanceof AST_New && p.expression === (this || _global)) return true;
        return (this || _global).expression instanceof AST_Function && p instanceof AST_PropAccess && p.expression === (this || _global) && (p1 = output.parent(1)) instanceof AST_Assign && p1.left === p;
      });
      PARENS(AST_New, function (output) {
        var p = output.parent();
        if (no_constructor_parens(this || _global, output) && (p instanceof AST_PropAccess || p instanceof AST_Call && p.expression === (this || _global))) return true;
      });
      PARENS(AST_Number, function (output) {
        var p = output.parent();
        if (this.getValue() < 0 && p instanceof AST_PropAccess && p.expression === (this || _global)) return true;
      });
      PARENS([AST_Assign, AST_Conditional], function (output) {
        ...
        if (p instanceof AST_Call && p.expression === (this || _global)) return true;
        if (p instanceof AST_Conditional && p.condition === (this || _global)) return true;
        if (p instanceof AST_PropAccess && p.expression === (this || _global)) return true;
      });
      ...
      AST_StatementWithBody.DEFMETHOD("_do_print_body", function (output) {
        force_statement((this || _global).body, output);
      });
      ...
      AST_Exit.DEFMETHOD("_do_print", function (output, kind) {
        ...
        if ((this || _global).value) {
          ...
          (this || _global).value.print(output);
        }
      ...
      AST_LoopControl.DEFMETHOD("_do_print", function (output, kind) {
        ...
        if ((this || _global).label) {
          output.space();

          (this || _global).label.print(output);
        }
      ...
      AST_SwitchBranch.DEFMETHOD("_do_print_body", function (output) {
        if ((this || _global).body.length > 0) {
          output.newline();

          (this || _global).body.forEach(function (stmt) {
            output.indent();
            stmt.print(output);
            output.newline();
          });
      ...
      AST_Definitions.DEFMETHOD("_do_print", function (output, kind) {
        ...
        (this || _global).definitions.forEach(function (def, i) {
          if (i) output.comma();
          def.print(output);
        });
        ...
        var avoid_semicolon = in_for && p.init === (this || _global);
    ...
    function Compressor(options, false_by_default) {
      if (!((this || _global) instanceof Compressor)) return new Compressor(options, false_by_default);
      TreeTransformer.call(this || _global, (this || _global).before, (this || _global).after);
      (this || _global).options = defaults(options, {
    ...
    merge(Compressor.prototype, {
      option: function (key) {
        return (this || _global).options[key];
      },
      warn: function () {
        if ((this || _global).options.warnings) AST_Node.warn.apply(AST_Node, arguments);
      },
      before: function (node, descend, in_list) {
        ...
        if (node instanceof AST_Scope) {
          node = node.hoist_declarations(this || _global);
          was_scope = true;
        }

        descend(node, this || _global);
        node = node.optimize(this || _global);

        if (was_scope && node instanceof AST_Scope) {
          node.drop_unused(this || _global);
          descend(node, this || _global);
        }
    ...
    (function () {
      ...
      (function (def) {
        ...
        def(AST_UnaryPrefix, function () {
          return member((this || _global).operator, unary_bool);
        });
        def(AST_Binary, function () {
          return member((this || _global).operator, binary_bool) || ((this || _global).operator == "&&" || (this || _global).operator == "||") && (this || _global).left.is_boolean() && (this || _global).right.is_boolean();
        });
        def(AST_Conditional, function () {
          return (this || _global).consequent.is_boolean() && (this || _global).alternative.is_boolean();
        });
        def(AST_Assign, function () {
          return (this || _global).operator == "=" && (this || _global).right.is_boolean();
        });
        def(AST_Seq, function () {
          return (this || _global).cdr.is_boolean();
        });
      ...
      (function (def) {
        ...
        def(AST_UnaryPrefix, function () {
          return (this || _global).operator == "typeof";
        });
        def(AST_Binary, function (compressor) {
          return (this || _global).operator == "+" && ((this || _global).left.is_string(compressor) || (this || _global).right.is_string(compressor));
        });
        def(AST_Assign, function (compressor) {
          return ((this || _global).operator == "=" || (this || _global).operator == "+=") && (this || _global).right.is_string(compressor);
        });
        def(AST_Seq, function (compressor) {
          return (this || _global).cdr.is_string(compressor);
        });
        def(AST_Conditional, function (compressor) {
          return (this || _global).consequent.is_string(compressor) && (this || _global).alternative.is_string(compressor);
        });
        def(AST_Call, function (compressor) {
          return compressor.option("unsafe") && (this || _global).expression instanceof AST_SymbolRef && (this || _global).expression.name == "String" && (this || _global).expression.undeclared();
        });
      })(function (node, func) {
      ...
      (function (def) {
        AST_Node.DEFMETHOD("evaluate", function (compressor) {
          if (!compressor.option("evaluate")) return [this || _global];

          try {
            var val = this._eval(compressor);

            return [best_of(make_node_from_constant(compressor, val, this || _global), this || _global), val];
          } catch (ex) {
            if (ex !== def) throw ex;
            return [this || _global];
          }
        ...
        AST_Node.DEFMETHOD("is_constant", function (compressor) {
          return (this || _global) instanceof AST_Constant || (this || _global) instanceof AST_UnaryPrefix && (this || _global).operator == "!" && (this || _global).expression instanceof AST_Constant || this.evaluate(compressor).length > 1;
        });
        AST_Node.DEFMETHOD("constant_value", function (compressor) {
          if ((this || _global) instanceof AST_Constant) return (this || _global).value;

          if ((this || _global) instanceof AST_UnaryPrefix && (this || _global).operator == "!" && (this || _global).expression instanceof AST_Constant) {
            return !(this || _global).expression.value;
          }
        ...
        def(AST_Statement, function () {
          throw new Error(string_template("Cannot evaluate a statement [{file}:{line},{col}]", (this || _global).start));
        });
        ...
        def(AST_UnaryPrefix, function (compressor) {
          var e = (this || _global).expression;

          switch ((this || _global).operator) {
            case "!":
        ...
        def(AST_Binary, function (c) {
          var left = (this || _global).left,
              right = (this || _global).right;
        ...
        def(AST_Conditional, function (compressor) {
          return ev((this || _global).condition, compressor) ? ev((this || _global).consequent, compressor) : ev((this || _global).alternative, compressor);
        });
        ...
        def(AST_Dot, function (compressor) {
          if (compressor.option("unsafe") && (this || _global).property == "length") {
            var str = ev((this || _global).expression, compressor);
      ...
      (function (def) {
        ...
        def(AST_Node, function () {
          return basic_negation(this || _global);
        });
        def(AST_Statement, function () {
        ...
        def(AST_UnaryPrefix, function () {
          if ((this || _global).operator == "!") return (this || _global).expression;
          return basic_negation(this || _global);
        });
        def(AST_Seq, function (compressor) {
          var self = this.clone();
        ...
        def(AST_Conditional, function (compressor) {
          ...
          return best_of(basic_negation(this || _global), self);
        });
        def(AST_Binary, function (compressor) {
          var self = this.clone(),
              op = (this || _global).operator;
        ...
        node.DEFMETHOD("negate", function (compressor) {
          return func.call(this || _global, compressor);
        });
      });
      ...
      (function (def) {
        ...
        def(AST_Call, function (compressor) {
          ...
          if (!pure) return true;
          if (typeof pure == "function") return pure(this || _global);
          return pure.indexOf((this || _global).expression.print_to_string()) < 0;
        });
        def(AST_Block, function (compressor) {
          for (var i = (this || _global).body.length; --i >= 0;) {
            if ((this || _global).body[i].has_side_effects(compressor)) return true;
          }

          return false;
        });
        def(AST_SimpleStatement, function (compressor) {
          return (this || _global).body.has_side_effects(compressor);
        });
        ...
        def(AST_Binary, function (compressor) {
          return (this || _global).left.has_side_effects(compressor) || (this || _global).right.has_side_effects(compressor);
        });
        def(AST_Assign, function (compressor) {
          return true;
        });
        def(AST_Conditional, function (compressor) {
          return (this || _global).condition.has_side_effects(compressor) || (this || _global).consequent.has_side_effects(compressor) || (this || _global).alternative.has_side_effects(compressor);
        });
        def(AST_Unary, function (compressor) {
          return (this || _global).operator == "delete" || (this || _global).operator == "++" || (this || _global).operator == "--" || (this || _global).expression.has_side_effects(compressor);
        });
        def(AST_SymbolRef, function (compressor) {
          return this.global() && this.undeclared();
        });
        def(AST_Object, function (compressor) {
          for (var i = (this || _global).properties.length; --i >= 0;) if ((this || _global).properties[i].has_side_effects(compressor)) return true;

          return false;
        });
        def(AST_ObjectProperty, function (compressor) {
          return (this || _global).value.has_side_effects(compressor);
        });
        def(AST_Array, function (compressor) {
          for (var i = (this || _global).elements.length; --i >= 0;) if ((this || _global).elements[i].has_side_effects(compressor)) return true;

          return false;
        });
        def(AST_Dot, function (compressor) {
          if (!compressor.option("pure_getters")) return true;
          return (this || _global).expression.has_side_effects(compressor);
        });
        def(AST_Sub, function (compressor) {
          if (!compressor.option("pure_getters")) return true;
          return (this || _global).expression.has_side_effects(compressor) || (this || _global).property.has_side_effects(compressor);
        });
        def(AST_PropAccess, function (compressor) {
          return !compressor.option("pure_getters");
        });
        def(AST_Seq, function (compressor) {
          return (this || _global).car.has_side_effects(compressor) || (this || _global).cdr.has_side_effects(compressor);
        });
      })(function (node, func) {
      ...
      (function (def) {
        ...
        function block_aborts() {
          var n = (this || _global).body.length;
          return n > 0 && aborts((this || _global).body[n - 1]);
        }

        def(AST_BlockStatement, block_aborts);
        def(AST_SwitchBranch, block_aborts);
        def(AST_If, function () {
          return (this || _global).alternative && aborts((this || _global).body) && aborts((this || _global).alternative) && (this || _global);
        });
      })(function (node, func) {
      ...
      AST_Definitions.DEFMETHOD("to_assignments", function () {
        var assignments = (this || _global).definitions.reduce(function (a, def) {
          if (def.value) {
      ...
      AST_Unary.DEFMETHOD("lift_sequences", function (compressor) {
        if (compressor.option("sequences")) {
          if ((this || _global).expression instanceof AST_Seq) {
            var seq = (this || _global).expression;
            var x = seq.to_array();
            (this || _global).expression = x.pop();
            x.push(this || _global);
      ...
      AST_Binary.DEFMETHOD("lift_sequences", function (compressor) {
        if (compressor.option("sequences")) {
          if ((this || _global).left instanceof AST_Seq) {
            var seq = (this || _global).left;
            var x = seq.to_array();
            (this || _global).left = x.pop();
            x.push(this || _global);
            seq = AST_Seq.from_array(x).transform(compressor);
            return seq;
          }

          if ((this || _global).right instanceof AST_Seq && (this || _global) instanceof AST_Assign && !has_side_effects_or_prop_access((this || _global).left, compressor)) {
            var seq = (this || _global).right;
            var x = seq.to_array();
            (this || _global).right = x.pop();
            x.push(this || _global);
            seq = AST_Seq.from_array(x).transform(compressor);
            return seq;
          }
    ...
    (function () {
      ...
      function def_to_moz(mytype, handler) {
        mytype.DEFMETHOD("to_mozilla_ast", function () {
          return set_moz_loc(this || _global, handler(this || _global));
        });
      }
