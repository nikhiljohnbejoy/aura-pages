...
export function dew() {
  ...
  !function (A, e) {
    ...
    "function" == typeof define && define.amd ? define([], e) : exports ? exports = e() : (A.AnchorJS = e(), A.anchors = new A.AnchorJS());
  }(exports, function () {
    "use strict";
    ...
    function A(A) {
      ...
      (this || _global).options = A || {}, (this || _global).elements = [], e((this || _global).options), (this || _global).isTouchDevice = function () {
        return !!("ontouchstart" in window || window.DocumentTouch && document instanceof DocumentTouch);
      }, (this || _global).add = function (A) {
        var i,
            o,
            s,
            c,
            ...
            p,
            w = [];
        if (e((this || _global).options), p = (this || _global).options.visible, "touch" === p && (p = this.isTouchDevice() ? "always" : "hover"), A || (A = "h1, h2, h3, h4, h5, h6"), i = t(A), 0 === i.length) return !1;

        for (n(), o = document.querySelectorAll("[id]"), s = [].map.call(o, function (A) {
          return A.id;
        }), r = 0; r < i.length; r++) if (this.hasAnchorJSLink(i[r])) w.push(r);else {
          ...
          d = c.replace(/-/g, " "), f = document.createElement("a"), f.className = "anchorjs-link " + (this || _global).options.class, f.href = "#" + c, f.setAttribute("aria-label", "Anchor link for: " + d), f.setAttribute("data-anchorjs-icon", (this || _global).options.icon), "always" === p && (f.style.opacity = "1"), "" === (this || _global).options.icon && (f.style.font = "1em/1 anchorjs-icons", "left" === (this || _global).options.placement && (f.style.lineHeight = "inherit")), "left" === (this || _global).options.placement ? (f.style.position = "absolute", f.style.marginLeft = "-1em", f.style.paddingRight = "0.5em", i[r].insertBefore(f, i[r].firstChild)) : (f.style.paddingLeft = "0.375em", i[r].appendChild(f));
        }

        for (r = 0; r < w.length; r++) i.splice(w[r] - r, 1);

        return (this || _global).elements = (this || _global).elements.concat(i), this || _global;
      }, (this || _global).remove = function (A) {
        for (var e, n, i = t(A), o = 0; o < i.length; o++) n = i[o].querySelector(".anchorjs-link"), n && (e = (this || _global).elements.indexOf(i[o]), -1 !== e && (this || _global).elements.splice(e, 1), i[o].removeChild(n));

        return this || _global;
      }, (this || _global).removeAll = function () {
        this.remove((this || _global).elements);
      }, (this || _global).urlify = function (A) {
        var t,
            n = /[& +$,:;=?@"#{}|^~[`%!'\]\.\/\(\)\*\\]/g;
        return (this || _global).options.truncate || e((this || _global).options), t = A.trim().replace(/\'/gi, "").replace(n, "-").replace(/-{2,}/g, "-").substring(0, (this || _global).options.truncate).replace(/^-+|-+$/gm, "").toLowerCase();
      }, (this || _global).hasAnchorJSLink = function (A) {
