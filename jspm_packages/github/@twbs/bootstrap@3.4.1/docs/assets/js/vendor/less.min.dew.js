  ...
  */
  !function (a, b) {
    ...
    w === b && (w = exports, x = c("./tree"), w.mode = "node"), w.Parser = function (a) {
      ...
      function u(a, b) {
        var c = r(a, b),
            ...
            h = c.split("\n");
        (this || _global).type = a.type || "Syntax", (this || _global).message = a.message, (this || _global).filename = a.filename || b.currentFileInfo.filename, (this || _global).index = a.index, (this || _global).line = "number" == typeof e ? e + 1 : null, (this || _global).callLine = g + 1, (this || _global).callExtract = h[g], (this || _global).stack = a.stack, (this || _global).column = f, (this || _global).extract = [h[e - 1], h[e], h[e + 1]];
      }
      ...
      var I = (this || _global).imports = {
        ...
        push: function (b, c, d, e) {
          ...
          J = j;
      return u.prototype = new Error(), u.prototype.constructor = u, (this || _global).env = a = a || {}, (this || _global).optimization = "optimization" in (this || _global).env ? (this || _global).env.optimization : 1, E = {
        imports: I,
        parse: function (d, e, f) {
          ...
          try {
            g = new x.Ruleset(null, (this || _global).parsers.primary()), g.root = !0, g.firstRoot = !0;
          } catch (n) {
            return e(new u(n, a));
          }
          ...
          return a.processImports === !1 ? p() : void new x.importVisitor((this || _global).imports, p).run(g);
        },
        parsers: F = {
          primary: function () {
            for (var a, b = (this || _global).mixin, c = J, d = []; C;) {
          ...
          alpha: function () {
            var a;
            if (j(/^\(opacity=/i)) return a = j(/^\d+/) || (this || _global).entities.variable(), a ? (n(")"), new x.Alpha(a)) : void 0;
          },
          element: function () {
            var b,
                c,
                g,
                h = y;
            return c = this.combinator(), b = j(/^(?:\d+\.\d+|\d+)%/) || j(/^(?:[.#]?|:*)(?:[\w-]|[^\x00-\x9f]|\\(?:[A-Fa-f0-9]{1,6} ?|[^A-Fa-f0-9]))+/) || k("*") || k("&") || this.attribute() || j(/^\([^()@]+\)/) || j(/^[\.#](?=@)/) || (this || _global).entities.variableCurly(), b || (d(), k("(") ? (g = this.selector()) && k(")") ? (b = new x.Paren(g), f()) : e() : f()), b ? new x.Element(c, b, h, a.currentFileInfo) : void 0;
          },
          combinator: function () {
            var a = v.charAt(y);
          ...
          selector: function (b) {
            for (var c, d, e, f, g, h, i, j = y, k = J; (b && (g = this.extend()) || b && (h = k(/^when/)) || (f = this.element())) && (h ? i = m((this || _global).conditions, "expected condition") : i ? o("CSS guard can only be used at the end of selector") : g ? d ? d.push(g) : d = [g] : (d && o("Extend can only be used at the end of selector"), e = v.charAt(y), c ? c.push(f) : c = [f], f = null), "{" !== e && "}" !== e && ";" !== e && "," !== e && ")" !== e););
          ...
          "import": function () {
            ...
            if (e) {
              ...
              if (b = (this || _global).entities.quoted() || (this || _global).entities.url()) return c = this.mediaFeatures(), i(";") || (y = d, o("missing semi-colon or unrecognised media features on import")), c = c && new x.Value(c), new x.Import(b, c, f, d, a.currentFileInfo);
      ...
      d.functions = {
        ...
        _minmax: function (a, c) {
          ...
          for (e = 0; e < c.length; e++) if (g = c[e], g instanceof d.Dimension) {
          ...
          return 1 == m.length ? m[0] : (c = m.map(function (a) {
            return a.toCSS((this || _global).env);
          }).join((this || _global).env.compress ? "," : ", "), new d.Anonymous((a ? "min" : "max") + "(" + c + ")"));
        },
        min: function () {
        ...
        "data-uri": function (b, e) {
          if ("undefined" != typeof a) return new d.URL(e || b, (this || _global).currentFileInfo).eval((this || _global).env);
          var f = b.value,
              g = e && e.value,
              h = c("./fs"),
              i = c("path"),
          ...
          if (-1 !== k && (l = g.slice(k), g = g.slice(0, k)), (this || _global).env.isPathRelative(g) && (g = (this || _global).currentFileInfo.relativeUrls ? i.join((this || _global).currentFileInfo.currentDirectory, g) : i.join((this || _global).currentFileInfo.entryPath, g)), arguments.length < 2) {
            var m;
          ...
          if (r >= q && (this || _global).env.ieCompat !== !1) return (this || _global).env.silent || console.warn("Skipped data-uri embedding of %s because its size (%dKB) exceeds IE8-safe %dKB!", g, r, q), new d.URL(e || b, (this || _global).currentFileInfo).eval((this || _global).env);
      ...
      d.defaultFunc = {
        eval: function () {
          var a = (this || _global).value_,
              b = (this || _global).error_;
          if (b) throw b;
          return null != a ? a ? d.True : d.False : void 0;
        },
        value: function (a) {
          (this || _global).value_ = a;
        },
        error: function (a) {
          (this || _global).error_ = a;
        },
        reset: function () {
          (this || _global).value_ = (this || _global).error_ = null;
        }
      }, g(), d.fround = function (a, b) {
        var c = a && a.numPrecision;
        return null == c ? b : Number((b + 2e-16).toFixed(c));
      }, d.functionCall = function (a, b) {
        (this || _global).env = a, (this || _global).currentFileInfo = b;
      ...
      a.Alpha = function (a) {
        ...
        type: "Alpha",
        accept: function (a) {
          (this || _global).value = a.visit((this || _global).value);
        },
        eval: function (b) {
          return (this || _global).value.eval ? new a.Alpha((this || _global).value.eval(b)) : this || _global;
        },
        genCSS: function (a, b) {
          b.add("alpha(opacity="), (this || _global).value.genCSS ? (this || _global).value.genCSS(a, b) : b.add((this || _global).value), b.add(")");
        },
        toCSS: a.toCSS
      };
    }(c("../tree")), function (a) {
      a.Anonymous = function (a, b, c, d, e) {
        (this || _global).value = a, (this || _global).index = b, (this || _global).mapLines = d, (this || _global).currentFileInfo = c, (this || _global).rulesetLike = "undefined" == typeof e ? !1 : e;
      }, a.Anonymous.prototype = {
        type: "Anonymous",
        eval: function () {
          return new a.Anonymous((this || _global).value, (this || _global).index, (this || _global).currentFileInfo, (this || _global).mapLines, (this || _global).rulesetLike);
        },
        compare: function (a) {
          if (!a.toCSS) return -1;
          var b = this.toCSS(),
        ...
        isRulesetLike: function () {
          return (this || _global).rulesetLike;
        },
        genCSS: function (a, b) {
          b.add((this || _global).value, (this || _global).currentFileInfo, (this || _global).index, (this || _global).mapLines);
        },
        toCSS: a.toCSS
      };
    }(c("../tree")), function (a) {
      a.Assignment = function (a, b) {
        (this || _global).key = a, (this || _global).value = b;
        ...
        eval: function (b) {
          return (this || _global).value.eval ? new a.Assignment((this || _global).key, (this || _global).value.eval(b)) : this || _global;
        },
        genCSS: function (a, b) {
          b.add((this || _global).key + "="), (this || _global).value.genCSS ? (this || _global).value.genCSS(a, b) : b.add((this || _global).value);
        },
        toCSS: a.toCSS
      };
    }(c("../tree")), function (a) {
      a.Call = function (a, b, c, d) {
        (this || _global).name = a, (this || _global).args = b, (this || _global).index = c, (this || _global).currentFileInfo = d;
      }, a.Call.prototype = {
        type: "Call",
        accept: function (a) {
          (this || _global).args && ((this || _global).args = a.visitArray((this || _global).args));
        },
        eval: function (b) {
          var c,
              d,
              e = (this || _global).args.map(function (a) {
            return a.eval(b);
          }),
              f = (this || _global).name.toLowerCase();

          if (f in a.functions) try {
            if (d = new a.functionCall(b, (this || _global).currentFileInfo), c = d[f].apply(d, e), null != c) return c;
          } catch (g) {
            throw {
              type: g.type || "Runtime",
              message: "error evaluating function `" + (this || _global).name + "`" + (g.message ? ": " + g.message : ""),
              index: (this || _global).index,
              filename: (this || _global).currentFileInfo.filename
            };
          }
          return new a.Call((this || _global).name, e, (this || _global).index, (this || _global).currentFileInfo);
        },
        genCSS: function (a, b) {
          b.add((this || _global).name + "(", (this || _global).currentFileInfo, (this || _global).index);

          for (var c = 0; c < (this || _global).args.length; c++) (this || _global).args[c].genCSS(a, b), c + 1 < (this || _global).args.length && b.add(", ");
      ...
      a.Color = function (a, b) {
        (this || _global).rgb = Array.isArray(a) ? a : 6 == a.length ? a.match(/.{2}/g).map(function (a) {
          return parseInt(a, 16);
        }) : a.split("").map(function (a) {
          return parseInt(a + a, 16);
        }), (this || _global).alpha = "number" == typeof b ? b : 1;
      };
      ...
      a.Color.prototype = {
        ...
        luma: function () {
          var a = (this || _global).rgb[0] / 255,
              b = (this || _global).rgb[1] / 255,
              c = (this || _global).rgb[2] / 255;
        ...
        toCSS: function (b, e) {
          var f = b && b.compress && !e,
              g = a.fround(b, (this || _global).alpha);
          if (1 > g) return 0 === g && (this || _global).isTransparentKeyword ? d : "rgba(" + (this || _global).rgb.map(function (a) {
        ...
        operate: function (b, c, d) {
          for (var e = [], f = (this || _global).alpha * (1 - d.alpha) + d.alpha, g = 0; 3 > g; g++) e[g] = a.operate(b, c, (this || _global).rgb[g], d.rgb[g]);

          return new a.Color(e, f);
        },
        toRGB: function () {
          return b((this || _global).rgb);
        },
        toHSL: function () {
          var a,
              b,
              c = (this || _global).rgb[0] / 255,
              d = (this || _global).rgb[1] / 255,
              e = (this || _global).rgb[2] / 255,
              f = (this || _global).alpha,
              g = Math.max(c, d, e),
              h = Math.min(c, d, e),
              i = (g + h) / 2,
              j = g - h;
        ...
        toARGB: function () {
          return b([255 * (this || _global).alpha].concat((this || _global).rgb));
        },
        compare: function (a) {
          return a.rgb && a.rgb[0] === (this || _global).rgb[0] && a.rgb[1] === (this || _global).rgb[1] && a.rgb[2] === (this || _global).rgb[2] && a.alpha === (this || _global).alpha ? 0 : -1;
        }
      ...
      a.Comment = function (a, b, c, d) {
        (this || _global).value = a, (this || _global).silent = !!b, (this || _global).currentFileInfo = d;
      }, a.Comment.prototype = {
        type: "Comment",
        genCSS: function (b, c) {
          (this || _global).debugInfo && c.add(a.debugInfo(b, this || _global), (this || _global).currentFileInfo, (this || _global).index), c.add((this || _global).value.trim());
        },
        toCSS: a.toCSS,
        isSilent: function (a) {
          var b = (this || _global).currentFileInfo && (this || _global).currentFileInfo.reference && !(this || _global).isReferenced,
              c = a.compress && !(this || _global).value.match(/^\/\*!/);
          return (this || _global).silent || b || c;
        },
        eval: function () {
          return this || _global;
        },
        markReferenced: function () {
          (this || _global).isReferenced = !0;
        }
      };
    }(c("../tree")), function (a) {
      a.Condition = function (a, b, c, d, e) {
        (this || _global).op = a.trim(), (this || _global).lvalue = b, (this || _global).rvalue = c, (this || _global).index = d, (this || _global).negate = e;
      }, a.Condition.prototype = {
        type: "Condition",
        accept: function (a) {
          (this || _global).lvalue = a.visit((this || _global).lvalue), (this || _global).rvalue = a.visit((this || _global).rvalue);
        },
        eval: function (a) {
          var b,
              c = (this || _global).lvalue.eval(a),
              d = (this || _global).rvalue.eval(a),
          ...
          }((this || _global).op), (this || _global).negate ? !b : b;
        }
      };
    }(c("../tree")), function (a) {
      a.DetachedRuleset = function (a, b) {
        (this || _global).ruleset = a, (this || _global).frames = b;
      }, a.DetachedRuleset.prototype = {
        type: "DetachedRuleset",
        accept: function (a) {
          (this || _global).ruleset = a.visit((this || _global).ruleset);
        },
        eval: function (b) {
          var c = (this || _global).frames || b.frames.slice(0);
          return new a.DetachedRuleset((this || _global).ruleset, c);
        },
        callEval: function (b) {
          return (this || _global).ruleset.eval((this || _global).frames ? new a.evalEnv(b, (this || _global).frames.concat(b.frames)) : b);
        }
      };
    }(c("../tree")), function (a) {
      a.Dimension = function (c, d) {
        (this || _global).value = parseFloat(c), (this || _global).unit = d && d instanceof a.Unit ? d : new a.Unit(d ? [d] : b);
      }, a.Dimension.prototype = {
        type: "Dimension",
        accept: function (a) {
          (this || _global).unit = a.visit((this || _global).unit);
        },
        eval: function () {
          return this || _global;
        },
        toColor: function () {
          return new a.Color([(this || _global).value, (this || _global).value, (this || _global).value]);
        },
        genCSS: function (b, c) {
          if (b && b.strictUnits && !(this || _global).unit.isSingular()) throw new Error("Multiple units in dimension. Correct the units or use the unit function. Bad unit: " + (this || _global).unit.toString());
          var d = a.fround(b, (this || _global).value),
              e = String(d);

          if (0 !== d && 1e-6 > d && d > -1e-6 && (e = d.toFixed(20).replace(/0+$/, "")), b && b.compress) {
            if (0 === d && (this || _global).unit.isLength()) return void c.add(e);
            d > 0 && 1 > d && (e = e.substr(1));
          }

          c.add(e), (this || _global).unit.genCSS(b, c);
        },
        toCSS: a.toCSS,
        operate: function (b, c, d) {
          var e = a.operate(b, c, (this || _global).value, d.value),
              f = (this || _global).unit.clone();
          ...
          if ("+" === c || "-" === c) {
            if (0 === f.numerator.length && 0 === f.denominator.length) f.numerator = d.unit.numerator.slice(0), f.denominator = d.unit.denominator.slice(0);else if (0 === d.unit.numerator.length && 0 === f.denominator.length) ;else {
              if (d = d.convertTo((this || _global).unit.usedUnits()), b.strictUnits && d.unit.toString() !== f.toString()) throw new Error("Incompatible units. Change the units or use the unit function. Bad units: '" + f.toString() + "' and '" + d.unit.toString() + "'.");
              e = a.operate(b, c, (this || _global).value, d.value);
            }
        ...
        compare: function (b) {
          if (b instanceof a.Dimension) {
            var c, d, e, f;
            if ((this || _global).unit.isEmpty() || b.unit.isEmpty()) c = this || _global, d = b;else if (c = this.unify(), d = b.unify(), 0 !== c.unit.compare(d.unit)) return -1;
        ...
        convertTo: function (b) {
          var c,
              ...
              f,
              g,
              h = (this || _global).value,
              i = (this || _global).unit.clone(),
              j = {};
        ...
        (this || _global).numerator = a ? a.slice(0).sort() : [], (this || _global).denominator = b ? b.slice(0).sort() : [], (this || _global).backupUnit = c;
      }, a.Unit.prototype = {
        type: "Unit",
        clone: function () {
          return new a.Unit((this || _global).numerator.slice(0), (this || _global).denominator.slice(0), (this || _global).backupUnit);
        },
        genCSS: function (a, b) {
          (this || _global).numerator.length >= 1 ? b.add((this || _global).numerator[0]) : (this || _global).denominator.length >= 1 ? b.add((this || _global).denominator[0]) : a && a.strictUnits || !(this || _global).backupUnit || b.add((this || _global).backupUnit);
        },
        toCSS: a.toCSS,
        toString: function () {
          var a,
              b = (this || _global).numerator.join("*");

          for (a = 0; a < (this || _global).denominator.length; a++) b += "/" + (this || _global).denominator[a];
        ...
        isEmpty: function () {
          return 0 === (this || _global).numerator.length && 0 === (this || _global).denominator.length;
        },
        isSingular: function () {
          return (this || _global).numerator.length <= 1 && 0 === (this || _global).denominator.length;
        },
        map: function (a) {
          var b;

          for (b = 0; b < (this || _global).numerator.length; b++) (this || _global).numerator[b] = a((this || _global).numerator[b], !1);

          for (b = 0; b < (this || _global).denominator.length; b++) (this || _global).denominator[b] = a((this || _global).denominator[b], !0);
        },
        usedUnits: function () {
          var b,
              c,
        ...
        cancel: function () {
          ...
          for (b = 0; b < (this || _global).numerator.length; b++) a = (this || _global).numerator[b], c || (c = a), d[a] = (d[a] || 0) + 1;

          for (b = 0; b < (this || _global).denominator.length; b++) a = (this || _global).denominator[b], c || (c = a), d[a] = (d[a] || 0) - 1;

          (this || _global).numerator = [], (this || _global).denominator = [];

          for (a in d) if (d.hasOwnProperty(a)) {
            var e = d[a];
            if (e > 0) for (b = 0; e > b; b++) (this || _global).numerator.push(a);else if (0 > e) for (b = 0; -e > b; b++) (this || _global).denominator.push(a);
          }

          0 === (this || _global).numerator.length && 0 === (this || _global).denominator.length && c && ((this || _global).backupUnit = c), (this || _global).numerator.sort(), (this || _global).denominator.sort();
        }
      };
    }(c("../tree")), function (a) {
      a.Directive = function (a, b, c, d, e, f) {
        (this || _global).name = a, (this || _global).value = b, c && ((this || _global).rules = c, (this || _global).rules.allowImports = !0), (this || _global).index = d, (this || _global).currentFileInfo = e, (this || _global).debugInfo = f;
      }, a.Directive.prototype = {
        type: "Directive",
        accept: function (a) {
          var b = (this || _global).value,
              c = (this || _global).rules;
        ...
        isCharset: function () {
          return "@charset" === (this || _global).name;
        },
        genCSS: function (b, c) {
          var d = (this || _global).value,
              e = (this || _global).rules;
          c.add((this || _global).name, (this || _global).currentFileInfo, (this || _global).index), d && (c.add(" "), d.genCSS(b, c)), e ? a.outputRuleset(b, c, [e]) : c.add(";");
        },
        toCSS: a.toCSS,
        eval: function (b) {
          var c = (this || _global).value,
              d = (this || _global).rules;
          return c && (c = c.eval(b)), d && (d = d.eval(b), d.root = !0), new a.Directive((this || _global).name, c, d, (this || _global).index, (this || _global).currentFileInfo, (this || _global).debugInfo);
        },
        variable: function (b) {
          return (this || _global).rules ? a.Ruleset.prototype.variable.call((this || _global).rules, b) : void 0;
        },
        find: function () {
          return (this || _global).rules ? a.Ruleset.prototype.find.apply((this || _global).rules, arguments) : void 0;
        },
        rulesets: function () {
          return (this || _global).rules ? a.Ruleset.prototype.rulesets.apply((this || _global).rules) : void 0;
        },
        markReferenced: function () {
          var a, b;
          if ((this || _global).isReferenced = !0, (this || _global).rules) for (b = (this || _global).rules.rules, a = 0; a < b.length; a++) b[a].markReferenced && b[a].markReferenced();
        }
      };
    }(c("../tree")), function (a) {
      a.Element = function (b, c, d, e) {
        (this || _global).combinator = b instanceof a.Combinator ? b : new a.Combinator(b), (this || _global).value = "string" == typeof c ? c.trim() : c ? c : "", (this || _global).index = d, (this || _global).currentFileInfo = e;
      }, a.Element.prototype = {
        type: "Element",
        accept: function (a) {
          var b = (this || _global).value;
          (this || _global).combinator = a.visit((this || _global).combinator), "object" == typeof b && ((this || _global).value = a.visit(b));
        },
        eval: function (b) {
          return new a.Element((this || _global).combinator, (this || _global).value.eval ? (this || _global).value.eval(b) : (this || _global).value, (this || _global).index, (this || _global).currentFileInfo);
        },
        genCSS: function (a, b) {
          b.add(this.toCSS(a), (this || _global).currentFileInfo, (this || _global).index);
        },
        toCSS: function (a) {
          var b = (this || _global).value.toCSS ? (this || _global).value.toCSS(a) : (this || _global).value;
          return "" === b && "&" === (this || _global).combinator.value.charAt(0) ? "" : (this || _global).combinator.toCSS(a || {}) + b;
        }
      }, a.Attribute = function (a, b, c) {
        (this || _global).key = a, (this || _global).op = b, (this || _global).value = c;
      }, a.Attribute.prototype = {
        type: "Attribute",
        eval: function (b) {
          return new a.Attribute((this || _global).key.eval ? (this || _global).key.eval(b) : (this || _global).key, (this || _global).op, (this || _global).value && (this || _global).value.eval ? (this || _global).value.eval(b) : (this || _global).value);
        },
        genCSS: function (a, b) {
          b.add(this.toCSS(a));
        },
        toCSS: function (a) {
          var b = (this || _global).key.toCSS ? (this || _global).key.toCSS(a) : (this || _global).key;
          return (this || _global).op && (b += (this || _global).op, b += (this || _global).value.toCSS ? (this || _global).value.toCSS(a) : (this || _global).value), "[" + b + "]";
        }
      }, a.Combinator = function (a) {
        (this || _global).value = " " === a ? " " : a ? a.trim() : "";
        ...
        genCSS: function (a, b) {
          var c = a.compress || (this || _global)._noSpaceCombinators[(this || _global).value] ? "" : " ";
          b.add(c + (this || _global).value + c);
        },
        toCSS: a.toCSS
      };
    }(c("../tree")), function (a) {
      a.Expression = function (a) {
        ...
        type: "Expression",
        accept: function (a) {
          (this || _global).value && ((this || _global).value = a.visitArray((this || _global).value));
        },
        eval: function (b) {
          var c,
              d = (this || _global).parens && !(this || _global).parensInOp,
              e = !1;
          return d && b.inParenthesis(), (this || _global).value.length > 1 ? c = new a.Expression((this || _global).value.map(function (a) {
            return a.eval(b);
          })) : 1 === (this || _global).value.length ? ((this || _global).value[0].parens && !(this || _global).value[0].parensInOp && (e = !0), c = (this || _global).value[0].eval(b)) : c = this || _global, d && b.outOfParenthesis(), (this || _global).parens && (this || _global).parensInOp && !b.isMathOn() && !e && (c = new a.Paren(c)), c;
        },
        genCSS: function (a, b) {
          for (var c = 0; c < (this || _global).value.length; c++) (this || _global).value[c].genCSS(a, b), c + 1 < (this || _global).value.length && b.add(" ");
        },
        toCSS: a.toCSS,
        throwAwayComments: function () {
          (this || _global).value = (this || _global).value.filter(function (b) {
      ...
      a.Extend = function (b, c, d) {
        switch ((this || _global).selector = b, (this || _global).option = c, (this || _global).index = d, (this || _global).object_id = a.Extend.next_id++, (this || _global).parent_ids = [(this || _global).object_id], c) {
          case "all":
            (this || _global).allowBefore = !0, (this || _global).allowAfter = !0;
            break;

          default:
            (this || _global).allowBefore = !1, (this || _global).allowAfter = !1;
        }
      }, a.Extend.next_id = 0, a.Extend.prototype = {
        type: "Extend",
        accept: function (a) {
          (this || _global).selector = a.visit((this || _global).selector);
        },
        eval: function (b) {
          return new a.Extend((this || _global).selector.eval(b), (this || _global).option, (this || _global).index);
        },
        clone: function () {
          return new a.Extend((this || _global).selector, (this || _global).option, (this || _global).index);
        },
      ...
      a.Import = function (a, c, d, e, f) {
        if ((this || _global).options = d, (this || _global).index = e, (this || _global).path = a, (this || _global).features = c, (this || _global).currentFileInfo = f, (this || _global).options.less !== b || (this || _global).options.inline) (this || _global).css = !(this || _global).options.less || (this || _global).options.inline;else {
          var g = this.getPath();
          g && /css([\?;].*)?$/.test(g) && ((this || _global).css = !0);
        }
      }, a.Import.prototype = {
        type: "Import",
        accept: function (a) {
          (this || _global).features && ((this || _global).features = a.visit((this || _global).features)), (this || _global).path = a.visit((this || _global).path), !(this || _global).options.inline && (this || _global).root && ((this || _global).root = a.visit((this || _global).root));
        },
        genCSS: function (a, b) {
          (this || _global).css && (b.add("@import ", (this || _global).currentFileInfo, (this || _global).index), (this || _global).path.genCSS(a, b), (this || _global).features && (b.add(" "), (this || _global).features.genCSS(a, b)), b.add(";"));
        },
        toCSS: a.toCSS,
        getPath: function () {
          if ((this || _global).path instanceof a.Quoted) {
            var c = (this || _global).path.value;
            return (this || _global).css !== b || /(\.[a-z]*$)|([\?;].*)$/.test(c) ? c : c + ".less";
          }

          return (this || _global).path instanceof a.URL ? (this || _global).path.value.value : null;
        },
        evalForImport: function (b) {
          return new a.Import((this || _global).path.eval(b), (this || _global).features, (this || _global).options, (this || _global).index, (this || _global).currentFileInfo);
        },
        evalPath: function (b) {
          var c = (this || _global).path.eval(b),
              d = (this || _global).currentFileInfo && (this || _global).currentFileInfo.rootpath;
        ...
        eval: function (b) {
          var c,
              d = (this || _global).features && (this || _global).features.eval(b);

          if ((this || _global).skip && ("function" == typeof (this || _global).skip && ((this || _global).skip = this.skip()), (this || _global).skip)) return [];

          if ((this || _global).options.inline) {
            var e = new a.Anonymous((this || _global).root, 0, {
              filename: (this || _global).importedFilename
            }, !0, !0);
            return (this || _global).features ? new a.Media([e], (this || _global).features.value) : [e];
          }

          if ((this || _global).css) {
            var f = new a.Import(this.evalPath(b), d, (this || _global).options, (this || _global).index);
            if (!f.css && (this || _global).error) throw (this || _global).error;
            return f;
          }

          return c = new a.Ruleset(null, (this || _global).root.rules.slice(0)), c.evalImports(b), (this || _global).features ? new a.Media(c.rules, (this || _global).features.value) : c.rules;
        }
      };
    }(c("../tree")), function (a) {
      a.JavaScript = function (a, b, c) {
        (this || _global).escaped = c, (this || _global).expression = a, (this || _global).index = b;
        ...
        eval: function (b) {
          var c,
              d = this || _global,
              e = {},
              f = (this || _global).expression.replace(/@\{([\w-]+)\}/g, function (c, e) {
          ...
          for (var i in h) h.hasOwnProperty(i) && (e[i.slice(1)] = {
            value: h[i].value,
            toJS: function () {
              return (this || _global).value.eval(b).toCSS();
            }
          });
          ...
          return "number" == typeof c ? new a.Dimension(c) : "string" == typeof c ? new a.Quoted('"' + c + '"', c, (this || _global).escaped, (this || _global).index) : new a.Anonymous(Array.isArray(c) ? c.join(", ") : c);
        }
      };
    }(c("../tree")), function (a) {
      a.Keyword = function (a) {
        ...
        genCSS: function (a, b) {
          if ("%" === (this || _global).value) throw {
            type: "Syntax",
            message: "Invalid % without number"
          };
          b.add((this || _global).value);
        },
        toCSS: a.toCSS,
        compare: function (b) {
          return b instanceof a.Keyword ? b.value === (this || _global).value ? 0 : 1 : -1;
        }
      }, a.True = new a.Keyword("true"), a.False = new a.Keyword("false");
    }(c("../tree")), function (a) {
      a.Media = function (b, c, d, e) {
        (this || _global).index = d, (this || _global).currentFileInfo = e;
        var f = this.emptySelectors();
        (this || _global).features = new a.Value(c), (this || _global).rules = [new a.Ruleset(f, b)], (this || _global).rules[0].allowImports = !0;
      }, a.Media.prototype = {
        type: "Media",
        accept: function (a) {
          (this || _global).features && ((this || _global).features = a.visit((this || _global).features)), (this || _global).rules && ((this || _global).rules = a.visitArray((this || _global).rules));
        },
        genCSS: function (b, c) {
          c.add("@media ", (this || _global).currentFileInfo, (this || _global).index), (this || _global).features.genCSS(b, c), a.outputRuleset(b, c, (this || _global).rules);
        },
        toCSS: a.toCSS,
        eval: function (b) {
          b.mediaBlocks || (b.mediaBlocks = [], b.mediaPath = []);
          var c = new a.Media(null, [], (this || _global).index, (this || _global).currentFileInfo);
          (this || _global).debugInfo && ((this || _global).rules[0].debugInfo = (this || _global).debugInfo, c.debugInfo = (this || _global).debugInfo);
          var d = !1;
          b.strictMath || (d = !0, b.strictMath = !0);

          try {
            c.features = (this || _global).features.eval(b);
          } finally {
            d && (b.strictMath = !1);
          }

          return b.mediaPath.push(c), b.mediaBlocks.push(c), b.frames.unshift((this || _global).rules[0]), c.rules = [(this || _global).rules[0].eval(b)], b.frames.shift(), b.mediaPath.pop(), 0 === b.mediaPath.length ? c.evalTop(b) : c.evalNested(b);
        },
        variable: function (b) {
          return a.Ruleset.prototype.variable.call((this || _global).rules[0], b);
        },
        find: function () {
          return a.Ruleset.prototype.find.apply((this || _global).rules[0], arguments);
        },
        rulesets: function () {
          return a.Ruleset.prototype.rulesets.apply((this || _global).rules[0]);
        },
        emptySelectors: function () {
          var b = new a.Element("", "&", (this || _global).index, (this || _global).currentFileInfo),
              c = [new a.Selector([b], null, null, (this || _global).index, (this || _global).currentFileInfo)];
          return c[0].mediaEmpty = !0, c;
        },
        markReferenced: function () {
          var a,
              b = (this || _global).rules[0].rules;

          for ((this || _global).rules[0].markReferenced(), (this || _global).isReferenced = !0, a = 0; a < b.length; a++) b[a].markReferenced && b[a].markReferenced();
        },
        evalTop: function (b) {
          var c = this || _global;
        ...
        bubbleSelectors: function (b) {
          b && ((this || _global).rules = [new a.Ruleset(b.slice(0), [(this || _global).rules[0]])]);
        }
      };
    }(c("../tree")), function (a) {
      a.mixin = {}, a.mixin.Call = function (b, c, d, e, f) {
        (this || _global).selector = new a.Selector(b), (this || _global).arguments = c && c.length ? c : null, (this || _global).index = d, (this || _global).currentFileInfo = e, (this || _global).important = f;
      }, a.mixin.Call.prototype = {
        type: "MixinCall",
        accept: function (a) {
          (this || _global).selector && ((this || _global).selector = a.visit((this || _global).selector)), (this || _global).arguments && ((this || _global).arguments = a.visitArray((this || _global).arguments));
        },
        eval: function (b) {
          var c,
              d,
          ...
          for (e = (this || _global).arguments && (this || _global).arguments.map(function (a) {
            return {
              name: a.name,
              value: a.value.eval(b)
            };
          }), f = 0; f < b.frames.length; f++) if ((c = b.frames[f].find((this || _global).selector)).length > 0) {
            ...
            for (g = 0; g < r.length; g++) if (l = r[g].group, l === u || l === m) try {
              d = r[g].mixin, d instanceof a.mixin.Definition || (o = d.originalRuleset || d, d = new a.mixin.Definition("", [], d.rules, null, !1), d.originalRuleset = o), Array.prototype.push.apply(p, d.evalCall(b, e, (this || _global).important).rules);
            } catch (x) {
              throw {
                message: x.message,
                index: (this || _global).index,
            ...
            if (q) {
              if (!(this || _global).currentFileInfo || !(this || _global).currentFileInfo.reference) for (f = 0; f < p.length; f++) k = p[f], k.markReferenced && k.markReferenced();
              return p;
            }
          }
          ...
          throw j ? {
            ...
            type: "Name",
            message: (this || _global).selector.toCSS().trim() + " is undefined",
            index: (this || _global).index,
            filename: (this || _global).currentFileInfo.filename
          };
        },
        format: function (a) {
          return (this || _global).selector.toCSS().trim() + "(" + (a ? a.map(function (a) {
            var b = "";
            return a.name && (b += a.name + ":"), b += a.value.toCSS ? a.value.toCSS() : "???";
          }).join(", ") : "") + ")";
        }
      }, a.mixin.Definition = function (b, c, d, e, f, g) {
        (this || _global).name = b, (this || _global).selectors = [new a.Selector([new a.Element(null, b, (this || _global).index, (this || _global).currentFileInfo)])], (this || _global).params = c, (this || _global).condition = e, (this || _global).variadic = f, (this || _global).arity = c.length, (this || _global).rules = d, (this || _global)._lookups = {}, (this || _global).required = c.reduce(function (a, b) {
          return !b.name || b.name && !b.value ? a + 1 : a;
        }, 0), (this || _global).parent = a.Ruleset.prototype, (this || _global).frames = g;
      }, a.mixin.Definition.prototype = {
        type: "MixinDefinition",
        accept: function (a) {
          (this || _global).params && (this || _global).params.length && ((this || _global).params = a.visitArray((this || _global).params)), (this || _global).rules = a.visitArray((this || _global).rules), (this || _global).condition && ((this || _global).condition = a.visit((this || _global).condition));
        },
        variable: function (a) {
          return (this || _global).parent.variable.call(this || _global, a);
        },
        variables: function () {
          return (this || _global).parent.variables.call(this || _global);
        },
        find: function () {
          return (this || _global).parent.find.apply(this || _global, arguments);
        },
        rulesets: function () {
          return (this || _global).parent.rulesets.apply(this || _global);
        },
        evalParams: function (b, c, d, e) {
          ...
          if (c = new a.evalEnv(c, [n].concat(c.frames)), d) for (d = d.slice(0), p = d.length, h = 0; p > h; h++) if (g = d[h], k = g && g.name) {
            ...
            throw {
              type: "Runtime",
              message: "Named argument for " + (this || _global).name + " " + d[h].name + " not found"
            };
          }
          ...
          for (m = 0, h = 0; h < o.length; h++) if (!e[h]) {
            if (g = d && d[m], k = o[h].name) if (o[h].variadic) {
              ...
              if (j = g && g.value) j = j.eval(b);else {
                if (!o[h].value) throw {
                  type: "Runtime",
                  message: "wrong number of arguments for " + (this || _global).name + " (" + p + " for " + (this || _global).arity + ")"
                };
        ...
        eval: function (b) {
          return new a.mixin.Definition((this || _global).name, (this || _global).params, (this || _global).rules, (this || _global).condition, (this || _global).variadic, (this || _global).frames || b.frames.slice(0));
        },
        evalCall: function (b, c, d) {
          var e,
              f,
              g = [],
              h = (this || _global).frames ? (this || _global).frames.concat(b.frames) : b.frames,
              i = this.evalParams(b, new a.evalEnv(b, h), c, g);
          return i.prependRule(new a.Rule("@arguments", new a.Expression(g).eval(b))), e = (this || _global).rules.slice(0), f = new a.Ruleset(null, e), f.originalRuleset = this || _global, f = f.eval(new a.evalEnv(b, [this || _global, i].concat(h))), d && (f = (this || _global).parent.makeImportant.apply(f)), f;
        },
        matchCondition: function (b, c) {
          return (this || _global).condition && !(this || _global).condition.eval(new a.evalEnv(c, [this.evalParams(c, new a.evalEnv(c, (this || _global).frames ? (this || _global).frames.concat(c.frames) : c.frames), b, [])].concat((this || _global).frames).concat(c.frames))) ? !1 : !0;
        },
        matchArgs: function (a, b) {
          var c,
              d = a && a.length || 0;

          if ((this || _global).variadic) {
            if (d < (this || _global).required - 1) return !1;
          } else {
            if (d < (this || _global).required) return !1;
            if (d > (this || _global).params.length) return !1;
          }

          c = Math.min(d, (this || _global).arity);

          for (var e = 0; c > e; e++) if (!(this || _global).params[e].name && !(this || _global).params[e].variadic && a[e].value.eval(b).toCSS() != (this || _global).params[e].value.eval(b).toCSS()) return !1;
      ...
      a.Negative = function (a) {
        ...
        genCSS: function (a, b) {
          b.add("-"), (this || _global).value.genCSS(a, b);
        },
        toCSS: a.toCSS,
        eval: function (b) {
          return b.isMathOn() ? new a.Operation("*", [new a.Dimension(-1), (this || _global).value]).eval(b) : new a.Negative((this || _global).value.eval(b));
        }
      };
    }(c("../tree")), function (a) {
      a.Operation = function (a, b, c) {
        (this || _global).op = a.trim(), (this || _global).operands = b, (this || _global).isSpaced = c;
      }, a.Operation.prototype = {
        type: "Operation",
        accept: function (a) {
          (this || _global).operands = a.visit((this || _global).operands);
        },
        eval: function (b) {
          var c = (this || _global).operands[0].eval(b),
              d = (this || _global).operands[1].eval(b);
          ...
          if (b.isMathOn()) {
            ...
            return c.operate(b, (this || _global).op, d);
          }

          return new a.Operation((this || _global).op, [c, d], (this || _global).isSpaced);
        },
        genCSS: function (a, b) {
          (this || _global).operands[0].genCSS(a, b), (this || _global).isSpaced && b.add(" "), b.add((this || _global).op), (this || _global).isSpaced && b.add(" "), (this || _global).operands[1].genCSS(a, b);
        },
        toCSS: a.toCSS
      ...
      a.Paren = function (a) {
        ...
        genCSS: function (a, b) {
          b.add("("), (this || _global).value.genCSS(a, b), b.add(")");
        },
        toCSS: a.toCSS,
        eval: function (b) {
          return new a.Paren((this || _global).value.eval(b));
        }
      };
    }(c("../tree")), function (a) {
      a.Quoted = function (a, b, c, d, e) {
        (this || _global).escaped = c, (this || _global).value = b || "", (this || _global).quote = a.charAt(0), (this || _global).index = d, (this || _global).currentFileInfo = e;
      }, a.Quoted.prototype = {
        type: "Quoted",
        genCSS: function (a, b) {
          (this || _global).escaped || b.add((this || _global).quote, (this || _global).currentFileInfo, (this || _global).index), b.add((this || _global).value), (this || _global).escaped || b.add((this || _global).quote);
        },
        toCSS: a.toCSS,
        eval: function (b) {
          var c = this || _global,
              d = (this || _global).value.replace(/`([^`]+)`/g, function (d, e) {
          ...
          return new a.Quoted((this || _global).quote + d + (this || _global).quote, d, (this || _global).escaped, (this || _global).index, (this || _global).currentFileInfo);
        },
        compare: function (a) {
          if (!a.toCSS) return -1;
          var b, c;
          return "Quoted" !== a.type || (this || _global).escaped || a.escaped ? (b = this.toCSS(), c = a.toCSS()) : (b = a.value, c = (this || _global).value), b === c ? 0 : c > b ? -1 : 1;
        }
      };
    }(c("../tree")), function (a) {
      function c(a, b) {
      ...
      a.Rule = function (c, d, e, f, g, h, i, j) {
        (this || _global).name = c, (this || _global).value = d instanceof a.Value || d instanceof a.Ruleset ? d : new a.Value([d]), (this || _global).important = e ? " " + e.trim() : "", (this || _global).merge = f, (this || _global).index = g, (this || _global).currentFileInfo = h, (this || _global).inline = i || !1, (this || _global).variable = j !== b ? j : c.charAt && "@" === c.charAt(0);
      }, a.Rule.prototype = {
        type: "Rule",
        accept: function (a) {
          (this || _global).value = a.visit((this || _global).value);
        ...
        genCSS: function (a, b) {
          b.add((this || _global).name + (a.compress ? ":" : ": "), (this || _global).currentFileInfo, (this || _global).index);

          try {
            (this || _global).value.genCSS(a, b);
          } catch (c) {
            throw c.index = (this || _global).index, c.filename = (this || _global).currentFileInfo.filename, c;
          }

          b.add((this || _global).important + ((this || _global).inline || a.lastRule && a.compress ? "" : ";"), (this || _global).currentFileInfo, (this || _global).index);
        },
        toCSS: a.toCSS,
        eval: function (b) {
          var d,
              e = !1,
              f = (this || _global).name,
              g = (this || _global).variable;
          "string" != typeof f && (f = 1 === f.length && f[0] instanceof a.Keyword ? f[0].value : c(b, f), g = !1), "font" !== f || b.strictMath || (e = !0, b.strictMath = !0);

          try {
            if (d = (this || _global).value.eval(b), !(this || _global).variable && "DetachedRuleset" === d.type) throw {
              message: "Rulesets cannot be evaluated on a property.",
              index: (this || _global).index,
              filename: (this || _global).currentFileInfo.filename
            };
            return new a.Rule(f, d, (this || _global).important, (this || _global).merge, (this || _global).index, (this || _global).currentFileInfo, (this || _global).inline, g);
          } catch (h) {
            throw "number" != typeof h.index && (h.index = (this || _global).index, h.filename = (this || _global).currentFileInfo.filename), h;
          } finally {
            e && (b.strictMath = !1);
          }
        },
        makeImportant: function () {
          return new a.Rule((this || _global).name, (this || _global).value, "!important", (this || _global).merge, (this || _global).index, (this || _global).currentFileInfo, (this || _global).inline);
        }
      };
    }(c("../tree")), function (a) {
      a.RulesetCall = function (a) {
        (this || _global).variable = a;
      }, a.RulesetCall.prototype = {
        type: "RulesetCall",
        accept: function () {},
        eval: function (b) {
          var c = new a.Variable((this || _global).variable).eval(b);
          return c.callEval(b);
        }
      };
    }(c("../tree")), function (a) {
      a.Ruleset = function (a, b, c) {
        (this || _global).selectors = a, (this || _global).rules = b, (this || _global)._lookups = {}, (this || _global).strictImports = c;
      }, a.Ruleset.prototype = {
        type: "Ruleset",
        accept: function (a) {
          (this || _global).paths ? a.visitArray((this || _global).paths, !0) : (this || _global).selectors && ((this || _global).selectors = a.visitArray((this || _global).selectors)), (this || _global).rules && (this || _global).rules.length && ((this || _global).rules = a.visitArray((this || _global).rules));
        },
        eval: function (b) {
          var c,
              d,
          ...
          var j,
              k,
              l = (this || _global).rules ? (this || _global).rules.slice(0) : null,
              m = new a.Ruleset(c, l, (this || _global).strictImports);
          m.originalRuleset = this || _global, m.root = (this || _global).root, m.firstRoot = (this || _global).firstRoot, m.allowImports = (this || _global).allowImports, (this || _global).debugInfo && (m.debugInfo = (this || _global).debugInfo), i || (l.length = 0);
          var n = b.frames;
          n.unshift(m);
          var o = b.selectors;
          o || (b.selectors = o = []), o.unshift((this || _global).selectors), (m.root || m.allowImports || !m.strictImports) && m.evalImports(b);
          var p = m.rules,
              q = p ? p.length : 0;
        ...
        makeImportant: function () {
          return new a.Ruleset((this || _global).selectors, (this || _global).rules.map(function (a) {
            return a.makeImportant ? a.makeImportant() : a;
          }), (this || _global).strictImports);
        },
        matchArgs: function (a) {
          return !a || 0 === a.length;
        },
        matchCondition: function (b, c) {
          var d = (this || _global).selectors[(this || _global).selectors.length - 1];
          return d.evaldCondition ? d.condition && !d.condition.eval(new a.evalEnv(c, c.frames)) ? !1 : !0 : !1;
        },
        resetCache: function () {
          (this || _global)._rulesets = null, (this || _global)._variables = null, (this || _global)._lookups = {};
        },
        variables: function () {
          return (this || _global)._variables || ((this || _global)._variables = (this || _global).rules ? (this || _global).rules.reduce(function (b, c) {
            return c instanceof a.Rule && c.variable === !0 && (b[c.name] = c), b;
          }, {}) : {}), (this || _global)._variables;
        },
        variable: function (a) {
          return this.variables()[a];
        },
        rulesets: function () {
          if (!(this || _global).rules) return null;
          var b,
              c,
              d = a.Ruleset,
              e = a.mixin.Definition,
              f = [],
              g = (this || _global).rules,
              h = g.length;
        ...
        prependRule: function (a) {
          var b = (this || _global).rules;
          b ? b.unshift(a) : (this || _global).rules = [a];
        },
        find: function (b, c) {
          c = c || this || _global;
          var d,
              e = [],
              f = b.toCSS();
          return f in (this || _global)._lookups ? (this || _global)._lookups[f] : (this.rulesets().forEach(function (f) {
        ...
        genCSS: function (b, c) {
          ...
          var e,
              ...
              l = [],
              m = [];
          b.tabLevel = b.tabLevel || 0, (this || _global).root || b.tabLevel++;
          var n,
              o = b.compress ? "" : Array(b.tabLevel + 1).join("  "),
              p = b.compress ? "" : Array(b.tabLevel).join("  ");

          for (e = 0; e < (this || _global).rules.length; e++) i = (this || _global).rules[e], d(i, (this || _global).root) ? m.push(i) : i.isCharset && i.isCharset() ? k.push(i) : l.push(i);

          if (l = k.concat(l), !(this || _global).root) {
            h = a.debugInfo(b, this || _global, p), h && (c.add(h), c.add(p));
            var q,
                r = (this || _global).paths,
                s = r.length;
          ...
          for (e = 0; e < l.length; e++) i = l[e], e + 1 !== l.length || (this || _global).root && 0 !== m.length && !(this || _global).firstRoot || (b.lastRule = !0), i.genCSS ? i.genCSS(b, c) : i.value && c.add(i.value.toString()), b.lastRule ? b.lastRule = !1 : c.add(b.compress ? "" : "\n" + o);

          if ((this || _global).root || (c.add(b.compress ? "}" : "\n" + p + "}"), b.tabLevel--), n = (b.compress ? "" : "\n") + ((this || _global).root ? o : p), g = m.length) for (l.length && n && c.add(n), m[0].genCSS(b, c), e = 1; g > e; e++) n && c.add(n), m[e].genCSS(b, c);
          c.isEmpty() || b.compress || !(this || _global).firstRoot || c.add("\n");
        },
        toCSS: a.toCSS,
        markReferenced: function () {
          if ((this || _global).selectors) for (var a = 0; a < (this || _global).selectors.length; a++) (this || _global).selectors[a].markReferenced();
        },
      ...
      a.Selector = function (a, b, c, d, e, f) {
        (this || _global).elements = a, (this || _global).extendList = b, (this || _global).condition = c, (this || _global).currentFileInfo = e || {}, (this || _global).isReferenced = f, c || ((this || _global).evaldCondition = !0);
      }, a.Selector.prototype = {
        type: "Selector",
        accept: function (a) {
          (this || _global).elements && ((this || _global).elements = a.visitArray((this || _global).elements)), (this || _global).extendList && ((this || _global).extendList = a.visitArray((this || _global).extendList)), (this || _global).condition && ((this || _global).condition = a.visit((this || _global).condition));
        },
        createDerived: function (b, c, d) {
          d = null != d ? d : (this || _global).evaldCondition;
          var e = new a.Selector(b, c || (this || _global).extendList, null, (this || _global).index, (this || _global).currentFileInfo, (this || _global).isReferenced);
          return e.evaldCondition = d, e.mediaEmpty = (this || _global).mediaEmpty, e;
        },
        match: function (a) {
          var b,
              c,
              d = (this || _global).elements,
              e = d.length;
        ...
        CacheElements: function () {
          ...
          if (!(this || _global)._elements) {
            for (a = (this || _global).elements.length, c = 0; a > c; c++) if (b = (this || _global).elements[c], d += b.combinator.value, b.value.value) {
            ...
            (this || _global)._elements = d.match(/[,&#\*\.\w-]([\w-]|(\\.))*/g), (this || _global)._elements ? "&" === (this || _global)._elements[0] && (this || _global)._elements.shift() : (this || _global)._elements = [];
          }
        },
        isJustParentSelector: function () {
          return !(this || _global).mediaEmpty && 1 === (this || _global).elements.length && "&" === (this || _global).elements[0].value && (" " === (this || _global).elements[0].combinator.value || "" === (this || _global).elements[0].combinator.value);
        },
        eval: function (a) {
          var b = (this || _global).condition && (this || _global).condition.eval(a),
              c = (this || _global).elements,
              d = (this || _global).extendList;
        ...
        genCSS: function (a, b) {
          var c, d;
          if (a && a.firstSelector || "" !== (this || _global).elements[0].combinator.value || b.add(" ", (this || _global).currentFileInfo, (this || _global).index), !(this || _global)._css) for (c = 0; c < (this || _global).elements.length; c++) d = (this || _global).elements[c], d.genCSS(a, b);
        },
        toCSS: a.toCSS,
        markReferenced: function () {
          (this || _global).isReferenced = !0;
        ...
        getIsReferenced: function () {
          return !(this || _global).currentFileInfo.reference || (this || _global).isReferenced;
        },
        getIsOutput: function () {
          return (this || _global).evaldCondition;
        }
      };
    }(c("../tree")), function (a) {
      ...
      a.URL = function (a, b, c) {
        (this || _global).value = a, (this || _global).currentFileInfo = b, (this || _global).isEvald = c;
      }, a.URL.prototype = {
        type: "Url",
        accept: function (a) {
          (this || _global).value = a.visit((this || _global).value);
        ...
        genCSS: function (a, b) {
          b.add("url("), (this || _global).value.genCSS(a, b), b.add(")");
        },
        toCSS: a.toCSS,
        eval: function (b) {
          var c,
              d = (this || _global).value.eval(b);

          if (!(this || _global).isEvald && (c = (this || _global).currentFileInfo && (this || _global).currentFileInfo.rootpath, c && "string" == typeof d.value && b.isPathRelative(d.value) && (d.quote || (c = c.replace(/[\(\)'"\s]/g, function (a) {
            return "\\" + a;
          ...
          return new a.URL(d, (this || _global).currentFileInfo, !0);
        }
      };
    }(c("../tree")), function (a) {
      a.Value = function (a) {
        ...
        eval: function (b) {
          return 1 === (this || _global).value.length ? (this || _global).value[0].eval(b) : new a.Value((this || _global).value.map(function (a) {
            return a.eval(b);
          }));
        },
        genCSS: function (a, b) {
          ...
          for (c = 0; c < (this || _global).value.length; c++) (this || _global).value[c].genCSS(a, b), c + 1 < (this || _global).value.length && b.add(a && a.compress ? "," : ", ");
        },
        toCSS: a.toCSS
      };
    }(c("../tree")), function (a) {
      a.Variable = function (a, b, c) {
        (this || _global).name = a, (this || _global).index = b, (this || _global).currentFileInfo = c || {};
      }, a.Variable.prototype = {
        type: "Variable",
        eval: function (b) {
          var c,
              d = (this || _global).name;
          if (0 === d.indexOf("@@") && (d = "@" + new a.Variable(d.slice(1)).eval(b).value), (this || _global).evaluating) throw {
            type: "Name",
            message: "Recursive variable definition for " + d,
            filename: (this || _global).currentFileInfo.file,
            index: (this || _global).index
          };
          if ((this || _global).evaluating = !0, c = a.find(b.frames, function (a) {
            var c = a.variable(d);
            return c ? c.value.eval(b) : void 0;
          })) return (this || _global).evaluating = !1, c;
          throw {
            type: "Name",
      ...
      a.parseEnv = function (a) {
        if (d(a, this || _global, b), (this || _global).contents || ((this || _global).contents = {}), (this || _global).contentsIgnoredChars || ((this || _global).contentsIgnoredChars = {}), (this || _global).files || ((this || _global).files = {}), "string" == typeof (this || _global).paths && ((this || _global).paths = [(this || _global).paths]), !(this || _global).currentFileInfo) {
          var c = a && a.filename || "input",
              e = c.replace(/[^\/\\]*$/, "");
          a && (a.filename = null), (this || _global).currentFileInfo = {
            filename: c,
            relativeUrls: (this || _global).relativeUrls,
      ...
      a.evalEnv = function (a, b) {
        d(a, this || _global, c), (this || _global).frames = b || [];
      }, a.evalEnv.prototype.inParenthesis = function () {
        (this || _global).parensStack || ((this || _global).parensStack = []), (this || _global).parensStack.push(!0);
      }, a.evalEnv.prototype.outOfParenthesis = function () {
        (this || _global).parensStack.pop();
      }, a.evalEnv.prototype.isMathOn = function () {
        return (this || _global).strictMath ? (this || _global).parensStack && (this || _global).parensStack.length : !0;
      ...
      a.visitor = function (b) {
        (this || _global)._implementation = b, (this || _global)._visitFnCache = [], e || (c(a, 1), e = !0);
      }, a.visitor.prototype = {
        visit: function (a) {
          if (!a) return a;
          var c = a.typeIndex;
          if (!c) return a;
          var e,
              f = (this || _global)._visitFnCache,
              g = (this || _global)._implementation,
              h = c << 1,
              i = 1 | h,
              j = f[h],
              k = f[i],
          ...
          return l.visitDeeper && a && a.accept && a.accept(this || _global), k != b && k.call(g, a), a;
        },
        visitArray: function (a, b) {
          ...
          if (b || !(this || _global)._implementation.isReplacing) {
      ...
      a.importVisitor = function (b, c, d, e, f) {
        if ((this || _global)._visitor = new a.visitor(this || _global), (this || _global)._importer = b, (this || _global)._finish = c, (this || _global).env = d || new a.evalEnv(), (this || _global).importCount = 0, (this || _global).onceFileDetectionMap = e || {}, (this || _global).recursionDetector = {}, f) for (var g in f) f.hasOwnProperty(g) && ((this || _global).recursionDetector[g] = !0);
        ...
        run: function (a) {
          ...
          try {
            (this || _global)._visitor.visit(a);
          } catch (c) {
            b = c;
          }

          (this || _global).isFinished = !0, 0 === (this || _global).importCount && this._finish(b);
        },
        visitImport: function (b, c) {
          ...
          if (!b.css || f) {
            try {
              d = b.evalForImport((this || _global).env);
            } catch (g) {
              g.filename || (g.index = b.index, g.filename = b.currentFileInfo.filename), b.css = !0, b.error = g;
            }

            if (d && (!d.css || f)) {
              b = d, (this || _global).importCount++;
              var h = new a.evalEnv((this || _global).env, (this || _global).env.frames.slice(0));
              b.options.multiple && (h.importMultiple = !0), (this || _global)._importer.push(b.getPath(), b.currentFileInfo, b.options, function (c, d, g, i) {
        ...
        visitDirective: function (a) {
          return (this || _global).env.frames.unshift(a), a;
        },
        visitDirectiveOut: function () {
          (this || _global).env.frames.shift();
        },
        ...
        visitMedia: function (a) {
          return (this || _global).env.frames.unshift(a.rules[0]), a;
        },
      ...
      a.joinSelectorVisitor = function () {
        (this || _global).contexts = [[]], (this || _global)._visitor = new a.visitor(this || _global);
      }, a.joinSelectorVisitor.prototype = {
        run: function (a) {
          return (this || _global)._visitor.visit(a);
        },
        visitRule: function (a, b) {
          b.visitDeeper = !1;
        },
        ...
        visitRuleset: function (a) {
          var b,
              c = (this || _global).contexts[(this || _global).contexts.length - 1],
              d = [];
          (this || _global).contexts.push(d), a.root || (b = a.selectors, b && (b = b.filter(function (a) {
            return a.getIsOutput();
          }), a.selectors = b.length ? b : b = null, b && a.joinSelectors(d, c, b)), b || (a.rules = null), a.paths = d);
        },
        visitRulesetOut: function () {
          (this || _global).contexts.length = (this || _global).contexts.length - 1;
        },
        visitMedia: function (a) {
          var b = (this || _global).contexts[(this || _global).contexts.length - 1];
          a.rules[0].root = 0 === b.length || b[0].multiMedia;
        }
      };
    }(c("./tree")), function (a) {
      a.toCSSVisitor = function (b) {
        (this || _global)._visitor = new a.visitor(this || _global), (this || _global)._env = b;
        ...
        visitComment: function (a) {
          return a.isSilent((this || _global)._env) ? [] : a;
        },
        visitMedia: function (a, b) {
          return a.accept((this || _global)._visitor), b.visitDeeper = !1, a.rules.length ? a : [];
        },
        visitDirective: function (b) {
          if (b.currentFileInfo.reference && !b.isReferenced) return [];

          if ("@charset" === b.name) {
            if ((this || _global).charset) {
              if (b.debugInfo) {
                var c = new a.Comment("/* " + b.toCSS((this || _global)._env).replace(/\n/g, "") + " */\n");
                return c.debugInfo = b.debugInfo, (this || _global)._visitor.visit(c);
              }

              return [];
            }

            (this || _global).charset = !0;
          }
        ...
        visitRuleset: function (b, c) {
          var d,
              e = [];
          if (b.firstRoot && this.checkPropertiesInRoot(b.rules), b.root) b.accept((this || _global)._visitor), c.visitDeeper = !1, (b.firstRoot || b.rules && b.rules.length > 0) && e.splice(0, 0, b);else {
            ...
            for (var f = b.rules, g = f ? f.length : 0, h = 0; g > h;) d = f[h], d && d.rules ? (e.push((this || _global)._visitor.visit(d)), f.splice(h, 1), g--) : h++;

            g > 0 ? b.accept((this || _global)._visitor) : b.rules = null, c.visitDeeper = !1, f = b.rules, f && (this._mergeRules(f), f = b.rules), f && (this._removeDuplicateRules(f), f = b.rules), f && f.length > 0 && b.paths.length > 0 && e.splice(0, 0, b);
          }
        ...
        _removeDuplicateRules: function (b) {
          if (b) {
            ...
            for (e = b.length - 1; e >= 0; e--) if (d = b[e], d instanceof a.Rule) if (f[d.name]) {
              c = f[d.name], c instanceof a.Rule && (c = f[d.name] = [f[d.name].toCSS((this || _global)._env)]);
              var g = d.toCSS((this || _global)._env);
      ...
      a.extendFinderVisitor = function () {
        (this || _global)._visitor = new a.visitor(this || _global), (this || _global).contexts = [], (this || _global).allExtendsStack = [[]];
      }, a.extendFinderVisitor.prototype = {
        run: function (a) {
          return a = (this || _global)._visitor.visit(a), a.allExtends = (this || _global).allExtendsStack[0], a;
        },
        visitRule: function (a, b) {
          b.visitDeeper = !1;
        },
          ...
          if (!b.root) {
            ...
            for (c = 0; c < j.length; c++) {
              ...
              for (f = m ? m.slice(0).concat(g) : g, f && (f = f.map(function (a) {
                return a.clone();
              })), d = 0; d < f.length; d++) (this || _global).foundExtends = !0, e = f[d], e.findSelfSelectors(k), e.ruleset = b, 0 === d && (e.firstExtendOnThisSelectorPath = !0), (this || _global).allExtendsStack[(this || _global).allExtendsStack.length - 1].push(e);
            }

            (this || _global).contexts.push(b.selectors);
          }
        },
        visitRulesetOut: function (a) {
          a.root || ((this || _global).contexts.length = (this || _global).contexts.length - 1);
        },
        visitMedia: function (a) {
          a.allExtends = [], (this || _global).allExtendsStack.push(a.allExtends);
        },
        visitMediaOut: function () {
          (this || _global).allExtendsStack.length = (this || _global).allExtendsStack.length - 1;
        },
        visitDirective: function (a) {
          a.allExtends = [], (this || _global).allExtendsStack.push(a.allExtends);
        },
        ...
        (this || _global)._visitor = new a.visitor(this || _global);
      }, a.processExtendsVisitor.prototype = {
        run: function (b) {
          var c = new a.extendFinderVisitor();
          return c.run(b), c.foundExtends ? (b.allExtends = b.allExtends.concat(this.doExtendChaining(b.allExtends, b.allExtends)), (this || _global).allExtendsStack = [b.allExtends], (this || _global)._visitor.visit(b)) : b;
        },
        doExtendChaining: function (b, c, d) {
          ...
          if (m.length) {
            if ((this || _global).extendChainCount++, d > 100) {
        ...
        visitRuleset: function (a) {
          if (!a.root) {
            var b,
                ...
                d,
                e,
                f = (this || _global).allExtendsStack[(this || _global).allExtendsStack.length - 1],
                g = [],
                h = this || _global;
        ...
        visitRulesetOut: function () {},
        visitMedia: function (a) {
          var b = a.allExtends.concat((this || _global).allExtendsStack[(this || _global).allExtendsStack.length - 1]);
          b = b.concat(this.doExtendChaining(b, a.allExtends)), (this || _global).allExtendsStack.push(b);
        },
        visitMediaOut: function () {
          (this || _global).allExtendsStack.length = (this || _global).allExtendsStack.length - 1;
        },
      ...
      a.sourceMapOutput = function (a) {
        (this || _global)._css = [], (this || _global)._rootNode = a.rootNode, (this || _global)._writeSourceMap = a.writeSourceMap, (this || _global)._contentsMap = a.contentsMap, (this || _global)._contentsIgnoredCharsMap = a.contentsIgnoredCharsMap, (this || _global)._sourceMapFilename = a.sourceMapFilename, (this || _global)._outputFilename = a.outputFilename, (this || _global)._sourceMapURL = a.sourceMapURL, a.sourceMapBasepath && ((this || _global)._sourceMapBasepath = a.sourceMapBasepath.replace(/\\/g, "/")), (this || _global)._sourceMapRootpath = a.sourceMapRootpath, (this || _global)._outputSourceFiles = a.outputSourceFiles, (this || _global)._sourceMapGeneratorConstructor = a.sourceMapGenerator || c("source-map").SourceMapGenerator, (this || _global)._sourceMapRootpath && "/" !== (this || _global)._sourceMapRootpath.charAt((this || _global)._sourceMapRootpath.length - 1) && ((this || _global)._sourceMapRootpath += "/"), (this || _global)._lineNumber = 0, (this || _global)._column = 0;
      }, a.sourceMapOutput.prototype.normalizeFilename = function (a) {
        return a = a.replace(/\\/g, "/"), (this || _global)._sourceMapBasepath && 0 === a.indexOf((this || _global)._sourceMapBasepath) && (a = a.substring((this || _global)._sourceMapBasepath.length), ("\\" === a.charAt(0) || "/" === a.charAt(0)) && (a = a.substring(1))), ((this || _global)._sourceMapRootpath || "") + a;
      }, a.sourceMapOutput.prototype.add = function (a, b, c, d) {
        if (a) {
          var e, f, g, h, i;

          if (b) {
            var j = (this || _global)._contentsMap[b.filename];
            (this || _global)._contentsIgnoredCharsMap[b.filename] && (c -= (this || _global)._contentsIgnoredCharsMap[b.filename], 0 > c && (c = 0), j = j.slice((this || _global)._contentsIgnoredCharsMap[b.filename])), j = j.substring(0, c), f = j.split("\n"), h = f[f.length - 1];
          }

          if (e = a.split("\n"), g = e[e.length - 1], b) if (d) for (i = 0; i < e.length; i++) (this || _global)._sourceMapGenerator.addMapping({
            generated: {
              line: (this || _global)._lineNumber + i + 1,
              column: 0 === i ? (this || _global)._column : 0
            },
            original: {
              line: f.length + i,
          ...
          });else (this || _global)._sourceMapGenerator.addMapping({
            generated: {
              line: (this || _global)._lineNumber + 1,
              column: (this || _global)._column
            },
            original: {
              line: f.length,
              column: h.length
          ...
          1 === e.length ? (this || _global)._column += g.length : ((this || _global)._lineNumber += e.length - 1, (this || _global)._column = g.length), (this || _global)._css.push(a);
        }
      }, a.sourceMapOutput.prototype.isEmpty = function () {
        return 0 === (this || _global)._css.length;
      }, a.sourceMapOutput.prototype.toCSS = function (a) {
        if ((this || _global)._sourceMapGenerator = new (this || _global)._sourceMapGeneratorConstructor({
          file: (this || _global)._outputFilename,
          sourceRoot: null
        }), (this || _global)._outputSourceFiles) for (var b in (this || _global)._contentsMap) if ((this || _global)._contentsMap.hasOwnProperty(b)) {
          var d = (this || _global)._contentsMap[b];
          (this || _global)._contentsIgnoredCharsMap[b] && (d = d.slice((this || _global)._contentsIgnoredCharsMap[b])), (this || _global)._sourceMapGenerator.setSourceContent(this.normalizeFilename(b), d);
        }

        if ((this || _global)._rootNode.genCSS(a, this || _global), (this || _global)._css.length > 0) {
          var e,
              f = JSON.stringify((this || _global)._sourceMapGenerator.toJSON());
          (this || _global)._sourceMapURL ? e = (this || _global)._sourceMapURL : (this || _global)._sourceMapFilename && (e = this.normalizeFilename((this || _global)._sourceMapFilename)), (this || _global)._writeSourceMap ? this._writeSourceMap(f) : e = "data:application/json;base64," + c("./encoder.js").encodeBase64(f), e && (this || _global)._css.push("/*# sourceMappingURL=" + e + " */");
        }

        return (this || _global)._css.join("");
      };
    }(c("./tree"));
    ...
    var C = /^text\/(x-)?less$/,
        ...
        E = {};
    if (w.watch = function () {
      return w.watchMode || (w.env = "development", v()), (this || _global).watchMode = !0, !0;
    }, w.unwatch = function () {
      return clearInterval(w.watchTimer), (this || _global).watchMode = !1, !1;
