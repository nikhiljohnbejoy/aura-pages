...
export function dew() {
  ...
  || function (view) {
    ...
    return saveAs;
  }(typeof self !== "undefined" && self || typeof window !== "undefined" && window || exports.content); // `self` is undefined in Firefox for Android content script context
