...
export function dew() {
  ...
  */
  !function (a, b) {
    "object" == typeof exports && true ? exports = b() : "function" == typeof define && define.amd ? define(b) : "object" == typeof exports ? exports.Holder = b() : a.Holder = b();
  }(exports, function () {
    return function (a) {
      function b(d) {
      ...
      (function (b) {
        ...
        function t(a) {
          K.vars.debounceTimer || a.call(this || _global), K.vars.debounceTimer && b.clearTimeout(K.vars.debounceTimer), K.vars.debounceTimer = b.setTimeout(function () {
            K.vars.debounceTimer = null, a.call(this || _global);
          }, K.setup.debounce);
        }
        ...
        var v = c(1),
          ...
          addTheme: function (a, b) {
            return null != a && null != b && (K.settings.themes[a] = b), delete K.vars.cache.themeKeys, this || _global;
          },
          ...
          flags: {
            dimensions: {
              regex: /^(\d+)x(\d+)$/,
              output: function (a) {
                var b = (this || _global).regex.exec(a);
            ...
            text: {
              regex: /text\:(.*)/,
              output: function (a) {
                return (this || _global).regex.exec(a)[1].replace("\\/", "/");
              }
            },
            font: {
              regex: /font\:(.*)/,
              output: function (a) {
                return (this || _global).regex.exec(a)[1];
              }
            },
            auto: {
              regex: /^auto$/
        ...
        for (var O in K.flags) K.flags.hasOwnProperty(O) && (K.flags[O].match = function (a) {
          return a.match((this || _global).regex);
        });
      ...
      var d = c(4),
        ...
        var c = 1,
          ...
          constructor: function (a) {
            c++, (this || _global).parent = null, (this || _global).children = {}, (this || _global).id = c, (this || _global).name = "n" + c, null != a && ((this || _global).name = a), (this || _global).x = 0, (this || _global).y = 0, (this || _global).z = 0, (this || _global).width = 0, (this || _global).height = 0;
          },
          resize: function (a, b) {
            null != a && ((this || _global).width = a), null != b && ((this || _global).height = b);
          },
          moveTo: function (a, b, c) {
            (this || _global).x = null != a ? a : (this || _global).x, (this || _global).y = null != b ? b : (this || _global).y, (this || _global).z = null != c ? c : (this || _global).z;
          },
          add: function (a) {
            var b = a.name;
            if (null != (this || _global).children[b]) throw "SceneGraph: child with that name already exists: " + b;
            (this || _global).children[b] = a, a.parent = this || _global;
          }
        }),
            f = d(e, function (b) {
          (this || _global).constructor = function () {
            b.constructor.call(this || _global, "root"), (this || _global).properties = a;
          };
        }),
            g = d(e, function (a) {
          function c(c, d) {
            if (a.constructor.call(this || _global, c), (this || _global).properties = {
              fill: "#000"
            }, null != d) b((this || _global).properties, d);else if (null != c && "string" != typeof c) throw "SceneGraph: invalid node name";
          }

          (this || _global).Group = d.extend(this || _global, {
            constructor: c,
            type: "group"
          }), (this || _global).Rect = d.extend(this || _global, {
            constructor: c,
            type: "rect"
          }), (this || _global).Text = d.extend(this || _global, {
            constructor: function (a) {
              c.call(this || _global), (this || _global).properties.text = a;
            },
            type: "text"
          });
        }),
            h = new f();
        return (this || _global).Shape = g, (this || _global).root = h, this || _global;
      };
      ...
      (function (a) {
        b.extend = function (a, b) {
          ...
          var c = new Image();
          c.onerror = function () {
            b.call(this || _global, !1);
          }, c.onload = function () {
            b.call(this || _global, !0);
          }, c.src = a;
