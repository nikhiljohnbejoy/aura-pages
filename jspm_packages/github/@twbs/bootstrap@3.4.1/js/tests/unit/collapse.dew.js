  ...
  $(function () {
    ...
    QUnit.test('should show a collapsed element', function (assert) {
      ...
      $('<div class="collapse"/>').on('shown.bs.collapse', function () {
        assert.ok($(this || _global).hasClass('in'), 'has class "in"');
        assert.ok(!/height/i.test($(this || _global).attr('style')), 'has height reset');
        done();
    ...
    QUnit.test('should reset style to auto after finishing opening collapse', function (assert) {
      ...
      $('<div class="collapse" style="height: 0px"/>').on('show.bs.collapse', function () {
        assert.strictEqual((this || _global).style.height, '0px', 'height is 0px');
      }).on('shown.bs.collapse', function () {
        assert.strictEqual((this || _global).style.height, '', 'height is auto');
        done();
      }).bootstrapCollapse('show');
    });
