...
export function dew() {
  ...
  $(function () {
    ...
    QUnit.test('should empty title attribute', function (assert) {
      assert.expect(1);
      var $trigger = $('<a href="#" rel="tooltip" title="Another tooltip"/>').appendTo('#qunit-fixture').bootstrapTooltip();
    ...
    QUnit.test('should assign a unique id tooltip element', function (assert) {
      assert.expect(2);
      var done = assert.async();
      $('<a href="#" rel="tooltip" title="Another tooltip"/>').appendTo('#qunit-fixture').on('shown.bs.tooltip', function () {
        var id = $('.tooltip').attr('id');
    ...
    QUnit.test('should place tooltips relative to placement option', function (assert) {
      assert.expect(2);
      var done = assert.async();
      var $tooltip = $('<a href="#" rel="tooltip" title="Another tooltip"/>').appendTo('#qunit-fixture').on('shown.bs.tooltip', function () {
    ...
    QUnit.test('should fire hide event', function (assert) {
      ...
      $('<div title="tooltip title"/>').appendTo('#qunit-fixture').on('shown.bs.tooltip', function () {
        $(this || _global).bootstrapTooltip('hide');
    ...
    QUnit.test('should place tooltips inside body when container is body', function (assert) {
      assert.expect(3);
      var done = assert.async();
      $('<a href="#" rel="tooltip" title="Another tooltip"/>').appendTo('#qunit-fixture').bootstrapTooltip({
        container: 'body'
    ...
    QUnit.test('should add position class before positioning so that position-specific styles are taken into account', function (assert) {
      ...
      var $tooltip = $container.find('.tooltip'); // this is some dumb hack shit because sub pixels in firefox
    ...
    QUnit.test('should use title attribute for tooltip text', function (assert) {
      assert.expect(2);
      var done = assert.async();
      $('<a href="#" rel="tooltip" title="Simple tooltip"/>').appendTo('#qunit-fixture').bootstrapTooltip().one('shown.bs.tooltip', function () {
    ...
    QUnit.test('should be placed dynamically to viewport with the dynamic placement option', function (assert) {
      ...
      var $topTooltip = $('<div style="left: 0; top: 0;" rel="tooltip" title="Top tooltip">Top Dynamic Tooltip</div>').appendTo($container).bootstrapTooltip({
        placement: 'auto',
      ...
      function leftTooltip() {
        var $leftTooltip = $('<div style="left: 0;" rel="tooltip" title="Left tooltip">Left Dynamic Tooltip</div>').appendTo($container).bootstrapTooltip({
          placement: 'auto left',
          viewport: '#qunit-fixture'
        });
      ...
      function rightTooltip() {
        var $rightTooltip = $('<div style="right: 0;" rel="tooltip" title="Right tooltip">Right Dynamic Tooltip</div>').appendTo($container).bootstrapTooltip({
    ...
    QUnit.test('should position arrow correctly when tooltip is moved to not appear offscreen', function (assert) {
      ...
      $('<a href="#" title="tooltip title" style="position: absolute; bottom: 0; right: 0;">Foobar</a>').appendTo('body').on('shown.bs.tooltip', function () {
        var arrowStyles = $(this || _global).data('bs.tooltip').$tip.find('.tooltip-arrow').attr('style');
    ...
    QUnit.test('should throw an error when template contains multiple top-level elements', function (assert) {
      assert.expect(1);
      assert.throws(function () {
        $('<a href="#" data-toggle="tooltip" title="Another tooltip"></a>').appendTo('#qunit-fixture').bootstrapTooltip({
